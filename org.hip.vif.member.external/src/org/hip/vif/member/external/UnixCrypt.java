...
public class UnixCrypt extends Object {
     ...
     * 
     * @param salt A two-character string representing the salt used to iterate the encryption engine in lots of
    ...
    /** Encrypt a password given the cleartext password. This method generates a random salt using the
     ...
     * 
     * @param encryptedPassword The encryptedPassword. The first two characters are assumed to be the salt. This string
     *            would be the same as one found in a Unix /etc/passwd file.
