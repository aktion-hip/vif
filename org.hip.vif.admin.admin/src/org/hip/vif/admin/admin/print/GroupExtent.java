...
/** Helper class, provides all queries (<code>IQueryStrategy</code>) to retrieve the content of a group. Useful as
 * parameter object.
 *
...
public class GroupExtent {
     ...
     *
     * @param inGroupID Long the group's ID.
     * @throws VException */
    public GroupExtent(final Long inGroupID) throws VException {
        groupID = inGroupID;
        order = createOrder();
        group = (Group) VifBOMHelper.getGroupHome().getGroup(inGroupID);
