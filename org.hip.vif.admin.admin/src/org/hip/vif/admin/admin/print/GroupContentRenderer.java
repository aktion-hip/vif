 ...
 * This class contains a structure of the group content, i.e. the questions including their completions.
 *
...
public class GroupContentRenderer {
    ...
    private class QuestionRenderer implements Comparable<QuestionRenderer> {
        ...
        public void renderAsOO(final JarOutputStream inJar)
            ...
            lParameters.put("StateOpenLbl", getMessage("admin.print.lbl.state.open")); //$NON-NLS-1$ //$NON-NLS-2$
            lParameters
    ...
    private class TextRenderer {
        ...
        TextRenderer(final Long inQuestionID) throws VException, SQLException {
            final QueryResult lTexts = VifBOMHelper.getJoinQuestionToTextHome()
        ...
        public void renderAsOO(final JarOutputStream inJar)
            ...
            final TransformerProxy lTransformer = new TransformerProxy(
                    ...
                    createStyleSheetParamter("BibliographyLbl", getMessage("admin.print.lbl.bibiograpy"))); //$NON-NLS-1$ //$NON-NLS-2$
            lTransformer.renderToStream(inJar, ""); //$NON-NLS-1$
