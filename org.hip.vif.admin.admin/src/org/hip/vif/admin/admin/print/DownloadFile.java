...
public class DownloadFile extends FileResource {
    ...
    /** Constructor.
     *
     * @param inGroups Collection of {@link GroupExtent}
    ...
    public DownloadFile(final Collection<GroupExtent> inGroups,
        ...
        try {
            final List<GroupContentRenderer> lContents = new ArrayList<GroupContentRenderer>(
                    groups.size());
            ...
            lJar.write(String
                    .format(Constants.CONTENT_START,
                            ...
                            messages.getFormattedMessage(
                                    "admin.print.meta.subtitle", dateFormat.format(new Date()))) //$NON-NLS-1$
                    .getBytes());
