...
/**
 * The menu item <code>Print Group</code>.
 * 
 * @author lbenno
 */
public class PrintGroupMenu implements IExtendibleMenuContribution {
	private static final IMessages MESSAGES = Activator.getMessages();

	@Override
	public String getLabel() {
		return MESSAGES.getMessage("admin.menu.print.group"); //$NON-NLS-1$
	}

	@Override
	public String getControllerName() {
		return UseCaseHelper
				.createFullyQualifiedControllerName(PrintGroupTask.class);
	}
