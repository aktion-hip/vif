...
/**
 * The menu item <code>Upgrade</code>.
 * 
 * @author lbenno
 */
public class UpgradeMenu implements IExtendibleMenuContribution {
	private static final IMessages MESSAGES = Activator.getMessages();

	@Override
	public String getLabel() {
		return MESSAGES.getMessage("admin.menu.upgrade"); //$NON-NLS-1$
	}

	@Override
	public String getControllerName() {
		return UseCaseHelper
				.createFullyQualifiedControllerName(UpgradeTask.class);
	}
