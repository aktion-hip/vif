...
/**
 * The menu item <code>Reindex</code>.
 * 
 * @author lbenno
 */
public class ReindexMenu implements IExtendibleMenuContribution {
	private static final IMessages MESSAGES = Activator.getMessages();

	@Override
	public String getLabel() {
		return MESSAGES.getMessage("admin.menu.reindex"); //$NON-NLS-1$
	}

	@Override
	public String getControllerName() {
		return UseCaseHelper
				.createFullyQualifiedControllerName(RefreshIndexTask.class);
	}
