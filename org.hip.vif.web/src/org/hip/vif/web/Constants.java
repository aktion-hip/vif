...
public final class Constants {
    ...
    public static final String EVENT_PROPERTY_NEXT_TASK = "next.controller"; //$NON-NLS-1$
    ...
    public static final String PERMISSION_DESCRIPTION_KEY = "vif.permission.description";
