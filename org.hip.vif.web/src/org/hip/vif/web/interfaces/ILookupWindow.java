...
public interface ILookupWindow {
	...
	/**
	 * The name of the task that controls the lookup's view. This class must implement {@link IPluggableTask}.
	 * 
	 ...
	 * 
	 * @return boolean <code>true</code> is lookup task is provided by the forum part, <code>false</code> if task is provided by admin part.
	 */
	boolean isForum();
