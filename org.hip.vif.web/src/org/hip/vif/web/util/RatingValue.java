 ...
 *
 * @author Luthiger Created: 27.12.2011 */
public enum RatingValue {
    ...
    RatingValue(final String inValue, final String inImg, final String inMsgKey) {
        value = inValue;
        img = inImg;
        msgKey = inMsgKey;
    }
    ...
    public boolean check(final String inCompare) {
