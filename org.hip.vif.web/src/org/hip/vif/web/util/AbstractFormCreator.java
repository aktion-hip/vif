 ...
 *
 * @deprecated use <code>org.ripla.web.util.AbstractFormCreator</code> instead
 * @author Luthiger Created: 10.11.2011 */
@Deprecated
public abstract class AbstractFormCreator {
     ...
     * @param inFieldID String must be unique on the form
     * @param inField {@link AbstractField}
     * @param inRequiredFieldLbl String the label of the required field, to generate the message
     *            <code>The field "FieldName" must not be empty!</code>
     * @return {@link Field} */
    protected Field addFieldRequired(final String inFieldID, final AbstractField inField,
