...
public class GroupImpl extends org.hip.vif.core.bom.impl.GroupImpl implements
	...
	/**
	 * Returns true if the specified external GroupID is the same as this
	 * entry's external GroupID
	 * 
	 * @param inGroupID
	 *            java.lang.String
	...
	/**
	 * Returns true if this group is of type where the contributions need to be
	...
	/**
	 * As administrators can add questions to a group that is created but not
	 * public, these questions are not indexed (and, consistently, arn't
	 * retrieved by a search query). However, such questions have to be made
	 * searchable as soon as the group is opened (transition from
	 * <code>created</code> to <code>open</code> state).
	 * 
	 * @throws SQLException
	 * @throws VException
	 * @throws IOException
	...
	/**
	 * We don't want content in closed groups to show up in a search query.
	 * Therefore, remove them from the index.
	 * 
	 * @throws IOException
	 * @throws SQLException
	 * @throws VException
