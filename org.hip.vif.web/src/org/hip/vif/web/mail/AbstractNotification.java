...
/**
 * <p>
 * Abstract class providing generic functionality for mails sent to notify a set
 * of users.<br/>
...
public abstract class AbstractNotification extends VObject implements IVIFMail {
	 ...
	 *            InternetAddress[]
	 * @param isBcc
	 *            boolean <code>True</code> if receiver addresses are set in the
	 *            mailBcc, else they are set in the mailTo
	 */
	 ...
	 * 
	 * @param inReceiverMails
	 *            Collection of {@link AddressAdapter}
	 * @param isBCC
	 *            boolean <code>True</code> if receiver addresses are set in the
	 *            mailBcc, else they are set in the mailTo
	 */
