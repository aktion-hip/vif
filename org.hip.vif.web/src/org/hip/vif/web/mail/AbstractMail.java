 ...
 * Implementations of the class can be used to send mails to a single person
 * with at most one single <code>cc</code>.
 * </p>
 * 
...
public abstract class AbstractMail extends VObject implements IVIFMail {
	 ...
	 * 
	 * @param inReceiver
	 *            VIFMember The member receiving the mail.
	 * @throws VException
	 * @throws IOException
	 */
	 ...
	 *            VIFMember The member receiving the mail.
	 * @param inSender
	 *            VIFMember The member sending the mail.
	 * @throws VException
	 * @throws IOException
	 */
	...
	/**
	 * Returns a localized message to a given ID and formats it with the
	 * specified argument.
	 * 
	 * @return java.lang.String
	 * @param inMsgId
	...
	/**
	 * Creates the address of the mail, e.g. Dear XY, Subclasses may overwrite
	 * this method.
	 * 
	 * @return StringBuilder
	 * @throws MailGenerationException
	...
	/**
	 * Returns the subject text, i.e. the text after the subject ID. Subclasses
	...
	/**
	 * Add additional mail address(es) If more then one, addresses must be comma
	 * separated.
	 * 
	 * @param inAdress
	 *            String Addition mail address(es)
	 */
