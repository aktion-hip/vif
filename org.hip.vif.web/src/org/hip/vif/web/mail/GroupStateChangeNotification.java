...
public class GroupStateChangeNotification extends AbstractNotification
	 ...
	 *            InternetAddress[]
	 * @param isBcc
	 *            boolean True if receiver addresses are set in the mailBcc,
	 *            else they are set in the mailTo
	...
	/**
	 * GroupStateChangeNotification constructor to create the automatic
	 * notification mail.
	 * 
	 * @param inReceiverMails
	 *            InternetAddress[]
	 * @param inMessage
	 *            String The message explaining the new state of the group.
	 * @param inGroupName
	 *            String
	 * @param isBcc
	 *            boolean True if receiver addresses are set in the mailBcc,
	...
	/**
	 * Creates the default subject text for the notification of group state
	 * changes.
	 * 
	 * @param inGroupName
	 *            String
