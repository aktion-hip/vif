...
public class ForumDashBoard extends VIFDashBoard {
	private Map<Integer, IMenuCommand> menuMap;
	
	public ForumDashBoard(VIFApplication inApplication) {
		super(inApplication);
	}

	@Override
	protected Collection<MenuFactory> getMenus() {
		return ControllerHelper.INSTANCE.getForumMenus();
	}
	...
	public Component getContentComponent(String inTaskName) throws NoTaskFoundException {
		return TaskManager.INSTANCE.getForumContent(inTaskName);
	}
