 ...
 *
 * @author Luthiger Created: 10.10.2010 */
public class RequestExpirationMail extends AbstractMail {
    ...
    private final Collection<Collector> entries;
     ...
     * @throws VException
     * @throws IOException */
    public RequestExpirationMail(final VIFMember inReceiver, final Collection<Collector> inEntries) throws VException,
            IOException {
        super(inReceiver);
        entries = inEntries;
    }
    ...
    protected StringBuilder getBody() {
        ...
        for (final Collector lEntry : entries) {
    ...
    protected StringBuilder getBodyHtml() {
        final TextParser lParser = new TextParser();
        int i = 0;
        final StringBuilder out = new StringBuilder();
        for (final Collector lEntry : entries) {
    ...
    private String getInsert(final int inNumber) {
