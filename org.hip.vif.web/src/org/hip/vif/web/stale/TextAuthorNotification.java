...
/** Mail to the author of a text contribution (e.g. <code>TextImpl</code>) to notify him that he should trigger the
 * request for review again.
 *
 * @author Luthiger Created: 03.03.2012 */
public class TextAuthorNotification extends AbstractMail {
     ...
     * @param inNotificator {@link StaleTextCollector} the object containing the collected text to send in the mail's
     *            body
     * @throws VException
     * @throws IOException */
    public TextAuthorNotification(final VIFMember inReceiver, final StaleTextCollector inNotificator)
