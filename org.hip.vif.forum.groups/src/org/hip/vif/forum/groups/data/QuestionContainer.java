...
public class QuestionContainer extends BeanItemContainer<QuestionWrapper> {
    ...
    public static final Object[] NATURAL_COL_ORDER = new Object[] { QUESTION_DECIMAL_ID, QUESTION_ID };
    public static final String[] COL_HEADERS = new String[] {
        "container.table.headers.id", "container.table.headers.question" }; //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * @throws VException
     * @throws SQLException */
    public static QuestionContainer createData(final QueryResult inQuestions) throws VException, SQLException {
