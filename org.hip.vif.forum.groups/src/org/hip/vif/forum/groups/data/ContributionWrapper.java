...
/** Bean wrapping a contribution model instance. A contribution is either a <code>Question</code>,
 * <code>Completion</code> or <code>Text</code> (aka. bibliography).
 *
...
public class ContributionWrapper implements ISelectableBean {
    ...
    private ContributionWrapper(final GeneralDomainObject inDomainObject, final EntryType inEntryType,
            final String inSortValue, final String inID, final String inPublicID, final String inText,
    ...
    public static ContributionWrapper createItem(final GeneralDomainObject inDomainObject, final EntryType inEntryType,
            final String inSortValue, final String inID, final String inPublicID, final String inText,
            final CodeList inCodeList) {
