...
public class AuthorReviewerRenderHelper {
    ...
    /** Convenience method to create a <code>AuthorReviewerRenderer</code> instance.
     *
     * @param inAuthorReviewer {@link GeneralDomainObject}
     * @param inTask {@link IPluggableWithLookup}
     * @param makeClickable boolean if <code>true</code>, the names are rendered clickable
    ...
    public static AuthorReviewerRenderer createRenderer(
            ...
            final IPluggableWithLookup inTask, final boolean makeClickable)
                    throws VException, SQLException {
        return makeClickable ? new ClickabelAuthorReviewerRenderer(
                inAuthorReviewer, inTask) : new AuthorReviewerRenderer(
                        inAuthorReviewer);
    }
    ...
    public static AuthorReviewerRenderer createRenderer(
            ...
            final IPluggableWithLookup inTask, final boolean makeClickable)
                    throws VException, SQLException {
        return makeClickable ? new ClickabelAuthorReviewerRenderer(inAuthors,
                inReviewers, inTask) : new AuthorReviewerRenderer(inAuthors,
                        inReviewers);
    }
    ...
    public static AuthorReviewerRenderer createRenderer(
            final QueryResult inAuthors, final QueryResult inReviewers)
                    throws VException, SQLException {
        return new AuthorReviewerRenderer(inAuthors, inReviewers);
    }

    /** Convenience method to create a <code>AuthorReviewerRenderer</code> instance.
     *
     * @param inAuthor {@link Member}
     * @param inReviewer {@link Member}
     * @param inTask {@link IPluggableWithLookup}
     * @param makeClickable boolean if <code>true</code>, the names are rendered clickable
     * @return {@link AuthorReviewerRenderer}
     * @throws VException
    ...
    public static AuthorReviewerRenderer createRenderer(final Member inAuthor,
            ...
            final boolean makeClickable) throws VException, SQLException {
        if (inReviewer == null) {
            return createRenderer(inAuthor, inTask, makeClickable);
        }
        return makeClickable ? new ClickabelAuthorReviewerRenderer(inAuthor,
                inReviewer, inTask) : new AuthorReviewerRenderer(inAuthor,
                        inReviewer);
    }

    /** Convenience method to create a <code>AuthorReviewerRenderer</code> instance.
     *
     * @param inAuthors Collection<MemberWrapper>
     * @param inReviewers Collection<MemberWrapper>
     * @param inTask {@link IPluggableWithLookup}
     * @param makeClickable boolean if <code>true</code>, the names are rendered clickable
     * @return {@link AuthorReviewerRenderer} */
    public static AuthorReviewerRenderer createRenderer(
     ...
     *
     * @param inMember GeneralDomainObject
    ...
    public static class AuthorReviewerRenderer {
         ...
         *
         * @param inAuthorLbl String
         * @param inReviewerLbl String
         * @param inDate String the formatted publication date
         * @return {@link Component} the possibly clickable component displaying the author/reviewer information */
    ...
    AuthorReviewerRenderer {
        ...
        ClickabelAuthorReviewerRenderer(final GeneralDomainObject inAuthor,
                final GeneralDomainObject inMember, final IPluggableWithLookup inTask)
                        throws VException, SQLException {
        ...
        public Component render(final String inAuthorLbl,
            ...
            out.addComponent(RiplaViewHelper.makeUndefinedWidth(new Label(
                    String.format("<span class=\"vif-contribution-date\">[%s]<span>", inDate), ContentMode.HTML))); //$NON-NLS-1$
            return out;
        }
        ...
        private Button createLink(final MemberWrapper inMember) {
            return LinkButtonHelper.createLinkButton(inMember.toString(),
                    LookupType.MEMBER, inMember.memberID, task);
        }
    }
