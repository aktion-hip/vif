 ...
 * Created: 27.07.2011
 */
public abstract class AbstractGroupsTask extends AbstractVIFTask {

	protected QueryResult getAuthors(String inQuestionID) throws VException, SQLException {
		return BOMHelper.getJoinQuestionToAuthorReviewerHome().getAuthors(inQuestionID);
	}

	protected QueryResult getReviewers(String inQuestionID) throws VException, SQLException {
		return BOMHelper.getJoinQuestionToAuthorReviewerHome().getReviewers(inQuestionID);
	}

	protected QueryResult getPublishedCompletions(Long inQuestionID) throws NumberFormatException, VException, SQLException {
		return BOMHelper.getJoinCompletionToMemberHome().selectPublishedWithResponsibles(inQuestionID);
	}

	protected QueryResult getPublishedBibliography(Long inQuestionID) throws VException, SQLException {
	 ...
	 * @throws SQLException
	 */
	protected QueryResult getDownloads(Long inTextID) throws VException, SQLException {
