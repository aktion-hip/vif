...
public class GroupListView extends CustomComponent {
	 ...
	 */
	public GroupListView(GroupContainer inGroups, GroupShowListTask inTask) {
		...
		lLayout.addComponent(new Label(String.format(VIFViewHelper.TMPL_TITLE, "vif-title", lMessages.getMessage("ui.group.list.view.title.page")), Label.CONTENT_XHTML)); //$NON-NLS-1$ //$NON-NLS-2$
