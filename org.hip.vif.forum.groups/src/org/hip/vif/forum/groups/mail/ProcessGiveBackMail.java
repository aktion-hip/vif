...
/**
 * Feedback sent to the author informing that the reviewer 
 * has given back the review task.
 * 
...
public class ProcessGiveBackMail extends MailWithLink {
	 ...
	 * @throws IOException
	 */
	public ProcessGiveBackMail(VIFMember inAuthor, VIFMember inReviewer, StringBuilder inNotificationText, StringBuilder inNotificationTextHtml) throws VException, IOException {
