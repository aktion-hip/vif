...
/**
 * This is a simple mail client, which can be used to send
 * <code>HMultipartMessages </code> (MimeMessages with Mulitpart content).
 * 
...
public class MailClient {
	 ...
	 */
	public void sendMail(VMultiPartMessage inMessage) throws MessagingException, NamingException {
		...
		Session lSession = createSession();		
	...
	private Session createSession() throws NamingException {
		...
		Context lJNDIContext = new InitialContext();
		Context lEnvironment = (Context)lJNDIContext.lookup("java:comp/env");
	 ...
	 */
	public void setMailHost(String inMailHost) {
		mailHost = inMailHost;	
	}
