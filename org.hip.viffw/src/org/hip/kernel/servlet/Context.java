 ...
 *  
 *  The HTTP is a stateless protocol. To keep track of state, the context holds parameters and properties persistent. 
 *  It uses the session-handling supported by webserver, servletengine und servlet-API.<br/><br/>
 *
 *  The context holds two type of values:<br>
 *
 *  <ol>
 *  	<li>The parameters (and file upload items) passed to the servlet in a request will be
 *  		hold in the context until next request.</li>
 *
 *  	<li>The other values set to the context are persistent and available as long as the
 *      session is valid (not new).</li>
 *	</ol>
 *
...
public interface Context {
	...
	/**
	 * Returns Array of Parameterstrings if found in context. Returns an empty
	 * Stringarray (length: 0) if no parameters are found in the context.
	 *
	 * @param inName java.lang.String Name of parameter
