...
public class ScriptLink extends AbstractResourceLink {
	...
	/**
	 * The Path to the javascript file has to be relative to the 
	 * specified resources root directory.
	 * This is defined in the VSys.properties.
	 *
	 * @param inHref java.lang.String - the relative path to the javascript file
	 */
	public ScriptLink(String inHref) {
		super(inHref);
	}
	 ...
	 */
	public ScriptLink(String inHref, String inMedia) {
	 ...
	 * <pre>&lt;script type="text/javascript" src="c:/vif/website/css/my.js">&lt;/script></pre>.
	 * 
