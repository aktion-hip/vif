...
public class CssLink extends AbstractResourceLink {
	...
	/**
	 * The Path to the css file has to be relative to the specified css rootdirectory.
	 * This is defined in the VSys.properties.
	 *
	 * @param inHref java.lang.String - the relative path to the css-file
	 */
	public CssLink(String inHref) {
		super(inHref);
	}
	 ...
	 */
	public CssLink(String inHref, String inMedia) {
		super(inHref, inMedia);
	}

	/**
	 * Returns HTML-String-Representation of a css-link, e.g.
	 * <pre>&lt;link rel="stylesheet" media="screen" type="text/css" href="c:/vif/website/css/my.css"></pre>
	 * 
