...
/**
 * This page can be used to redirect the output to a specified page by using
 * the meta refresh tag.
 * <pre><meta http-equiv="refresh" content="0; URL=./redirected.html"></pre>
 * 
...
public class RedirectPage extends AbstractHtmlPage {
	 ...
	 */
	public RedirectPage(String inUrl) {
		super();
		url = inUrl;
	}
	 ...
	 * @param inUrl java.lang.String
	 */
	public RedirectPage(Context inContext, String inUrl) {
		super(inContext);
		url = inUrl;
	}
	 ...
	 * Contains <pre><meta http-equiv="refresh" content="0; URL=./redirected.html"></pre>.
	 *
	 * @return java.lang.String
	 */ 
	protected String createBegin() {
		StringBuffer outBegin = new StringBuffer(HTML_BEGIN);
		outBegin.append(HEAD_BEGIN).append(META1).append(seconds).append(META2).append(url).append(META3).append(HEAD_END).append(BODY);
	 ...
	 */
	public void setDelay(int inSecondes) {
