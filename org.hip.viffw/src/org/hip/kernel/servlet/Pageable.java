...
/**
 * 	Interface for views supporting a navigation over pages with data (list). <p/>
 *
 *  For example: A view shows a part of a list of something (first page). This interfaces
 *  defines some methods for navigating over the hole data (list). <p/>
 *
 *  e.g.: To load data of next page (in this case page means a list of data) into the view, call the
 *        method <code>nextPage()</code>.
 *
