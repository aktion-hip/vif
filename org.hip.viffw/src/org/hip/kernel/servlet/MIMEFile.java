...
/**
 * 	Represents a file with MIME-type other then html
 *  (e.g. DIF = data interchange format).
 *  This interface can be used to export data from the server to the
 *  clients hard-disk in a format which depends on the used XSLT.
 *
...
public interface MIMEFile extends View {
	...
	/**
	 * Adds a new file to this file-set.
	 * Although the type of the inputed class has to be HtmlView, the
	 * content of the class has not to be html. The content is dependent
	 * of the XSLT transformation applied on the XML data.
	 *
	 * @param inView org.hip.kernel.servlet.HtmlView
	 */
	public void add(HtmlView inFile);
