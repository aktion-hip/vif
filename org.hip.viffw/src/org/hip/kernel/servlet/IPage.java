...
/**
 * Inteface for html pages. A page contains a set of <code>HtmlView</code>s.
 * A page corresponds to all html code that defines the content displayed on a browser page.
 *
 * @author Luthiger
