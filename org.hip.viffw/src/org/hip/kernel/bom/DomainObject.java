...
/**
 * The DomainObject is the base interface for all domain
 * related objects. We use the name domain object in the
 * same way as Ivar Jacobson does in his book
 * "UML Unified Software Development Process"
 *
