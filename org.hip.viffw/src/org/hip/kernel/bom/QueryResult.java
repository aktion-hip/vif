...
/**
 * 	The QueryResult is a kind of iterator. It is the return
 *	object of the DomainHome.query method.
 * 
...
public interface QueryResult {
	...
	// Class variables
	public static int	DEFAULT_PAGE_LENGTH	= 20;

	/**
	 * 	Propagates the close to the internally hold 
	 *	ResulSet. See JDBC documentation for further
	 *	informations.
	 * 
	 */
	...
	/**
	 * 	This method returns the KeyObj of the current DomainObject. Null
	 *	is returned if there is no current object
	 * 
	 ...
	 * @throws BOMException
	 */
	String nextAsXMLString(String inSerializerName, boolean inUseFilter, Locale inLocale) throws SQLException, BOMException;
	
	/**
	 * 	Returns a DomainObjectCollection containing the specified amount of
	 *  DomainObjects.
	 * 
	 ...
	 * @exception org.hip.kernel.bom.BOMException
	 */
	String nextnAsXMLString(int inHowMany, String inSerializerName, boolean inUseFilter) throws SQLException, BOMException;
	 ...
	 * @throws BOMException
	 */
	String nextnAsXMLString(int inHowMany, String inSerializerName, boolean inUseFilter, Locale inLocale) throws SQLException, BOMException;
