...
/**
 * This interface defines the general responsibilities of "Homes" 
 * for domain objects. General in this context means the whole
 * functionality for read only domain objects (i.e. no insert and delete).
 *
 * @author Benno Luthiger
 */
public interface GeneralDomainObjectHome extends Home {
	// Class variables
	 ...
	 * @throws BOMException
	 */
	int getCount(KeyObject inKeyObject, HavingObject inHaving, GroupByObject inGroupBy) throws SQLException, BOMException;
	...
	/**
	 * Returns an instance of the visitor named key.
	...
	/**
	 * This method allows to invoke a query. It selects all entries in the table. 
	 ...
	 * @throws org.hip.kernel.bom.BOMException
	 */
	QueryResult select(KeyObject inKey, OrderObject inOrder, HavingObject inHaving, GroupByObject inGroupBy) throws SQLException, BOMException;
	...
	/**
	 * This method selects all domain objects of the corresponding 
	 * table or tables (if join) and returns a QueryResult limited by
	 * the specified LimitObject.
	 * 
