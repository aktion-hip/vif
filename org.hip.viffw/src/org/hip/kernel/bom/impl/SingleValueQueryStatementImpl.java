 ...
 */
public class SingleValueQueryStatementImpl extends VObject implements SingleValueQueryStatement {
	 ...
	 * @see org.hip.kernel.bom.SingleValueQueryStatement 
	 */
	public BigDecimal executeQuery(String inSQL) throws SQLException {
		//pre
		if (VSys.assertNotNull(this, "executeQuery", inSQL)) return new BigDecimal(0);
	 ...
	 * @throws SQLException
	 */
	public Collection<Object> executeQuery2(String inSQL) throws SQLException {
		//pre
		if (VSys.assertNotNull(this, "executeQuery", inSQL)) return new Vector<Object>();
		return prepareDataRetrieval(inSQL);
	}
	
	private Collection<Object> prepareDataRetrieval(String inSQL) throws SQLException {
		Collection<Object> outValues = new Vector<Object>();
		outValues.add(new BigDecimal(0));
		...
		try {
			...
			if (lStatement != null)
				lStatement.close();
			if (lConnection != null) {
				for (SQLWarning lWarning = lConnection.getWarnings(); lWarning != null; lWarning = lWarning.getNextWarning()) {
	...
	private Collection<Object> loadFromResultSet(ResultSet inResult) throws SQLException {
		Collection<Object> outValues = new Vector<Object>();
