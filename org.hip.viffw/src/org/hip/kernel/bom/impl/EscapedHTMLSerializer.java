 ...
 * This serializer converts these formatings to escaped HTML text.
 * 
...
public class EscapedHTMLSerializer extends AbstractStructuredTextSerializer {
	 ...
	 * @param inLevel
	 */
	public EscapedHTMLSerializer(int inLevel) {
		super(inLevel);
	}
	 ...
	 * @param inFilter
	 */
	public EscapedHTMLSerializer(int inLevel, XMLCharacterFilter inFilter) {
	 ...
	 * @param inFilter
	 */
	public EscapedHTMLSerializer(XMLCharacterFilter inFilter) {
		super(inFilter);
	}
	 ...
	 * org.hip.kernel.stext.EscapedHTMLSerializer.
	 * 
