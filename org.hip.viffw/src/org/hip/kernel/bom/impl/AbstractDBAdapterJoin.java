...
public abstract class AbstractDBAdapterJoin extends VObject {
	 ...
	 */
	public AbstractDBAdapterJoin(JoinedObjectDef inObjectDef) {
		super();
	...
	public String createSelectAllSQL() throws BOMException {
		String outSQL = getSelectSQL(false);
	 ...
	 * @throws org.hip.kernel.bom.BOMException
	 */
	public String createSelectSQL(OrderObject inOrder, GeneralDomainObjectHome inDomainObjectHome) throws BOMException {
		String outSQL = getSelectSQL(false) + 
	...
	public String createSelectSQL(KeyObject inKey, LimitObject inLimit, GeneralDomainObjectHome inDomainObjectHome) throws BOMException {
		String outSQL = getSelectSQL(inKey.isDistinct()) +
	...
	protected String getSelectSQL(boolean inDistinct) throws BOMException {
		if (selectSQL == null) {
	...
	protected String getCountSQL(boolean inDistinct) throws BOMException {
		if (countSQL == null) {
	...
	private String createSelectSQL(boolean inDistinct) throws BOMException {
		StringBuilder out = new StringBuilder(SQL_SELECT);
		out.append(inDistinct ? SQL_DISTINCT : "");
		out.append(getFields()).append(" ");
		out.append(getFromSQL());
		return new String(out);
	}
	
	private String createCountSQL(boolean inDistinct) throws BOMException {
		StringBuilder out = new StringBuilder(SQL_SELECT);
		out.append(inDistinct ? SQL_DISTINCT : "");
		out.append(getCountFields()).append(" ");
		out.append(getFromSQL());
		return new String(out);
	}
	...
	protected String getCountFields() {
		...
		Iterator<String> lColumns = getColumns().iterator();
		if (lColumns.hasNext()) {
	 ...
	 * @return java.lang.String
	 */
	protected String findType(String[][] inTypes, String inTypeKey) throws BOMException {
		if ("NO_JOIN".equals(inTypeKey)) return "";
	 ...
	 * @return java.lang.String
	 */
	protected String createSQLWhere(String inSQLPart, KeyObject inKey, GeneralDomainObjectHome inDomainObjectHome) {
		// Pre: inKey not null
		if (inKey == null)
			return "";
	 ...
	 * @return java.lang.String
	 */
	protected String createOrderBy(String inSQLPart, OrderObject inOrder, GeneralDomainObjectHome inDomainObjectHome) {
	...
	/**
	 * Renders the from part of the SQL JOIN statement.
	...
	protected String getFromSQL() throws BOMException {
		...
		boolean lFirst = true;
		for (Iterator<?> lOperations = getJoinDef().getJoinOperations().iterator(); lOperations.hasNext();) {
			JoinOperation lOperation = (JoinOperation)lOperations.next();
			if (lFirst) {
				lLeftmostTable = lOperation.getLeftTableName();
			}
			lFirst = false;
			String lJoinType = lOperation.getJoinType();
			if (!JoinDef.NO_JOIN_TYPE.equals(lJoinType)) {
				outSQL.append(findType(getJoinTypes(), lOperation.getJoinType()));
				outSQL.append((lOperation.getRightTableName() == "" ? lOperation.getLeftTableName() : lOperation.getRightTableName())  + " ON ");
	 ...
	 * @throws org.hip.kernel.bom.BOMException
	 */
	public String createSelectSQL(KeyObject inKey, GeneralDomainObjectHome inDomainObjectHome) throws BOMException {
		String outSQL = getSelectSQL(inKey.isDistinct()) + 
	 ...
	 * @throws org.hip.kernel.bom.BOMException
	 */
	public String createSelectSQL(KeyObject inKey, OrderObject inOrder, GeneralDomainObjectHome inDomainObjectHome) throws BOMException {
		String outSQL = getSelectSQL(inKey.isDistinct()) + 
			createSQLWhere(getWhereAdder(), inKey, inDomainObjectHome) + 
			createOrderBy(SQL_ORDER_BY, inOrder, inDomainObjectHome);
		LOG.debug("createSelectSQL {}", outSQL);
	 ...
	 */
	public String createSelectSQL(KeyObject inKey, OrderObject inOrder, HavingObject inHaving, GeneralDomainObjectHome inDomainObjectHome) throws BOMException {
		String outSQL = getSelectSQL(inKey.isDistinct()) + 
			createSQLWhere(getWhereAdder(), inKey, inDomainObjectHome) + 
	 ...
	 * @throws BOMException
	 */
	public String createSelectSQL(KeyObject inKey, OrderObject inOrder, HavingObject inHaving, GroupByObject inGroupBy, GeneralDomainObjectHome inDomainObjectHome) throws BOMException {
		String outSQL = getSelectSQL(inKey.isDistinct()) + 
			createSQLWhere(getWhereAdder(), inKey, inDomainObjectHome) + 
	 ...
	 * @throws org.hip.kernel.bom.BOMException
	 */
	public String createCountSQL(KeyObject inKey, GeneralDomainObjectHome inHome) throws BOMException {
		String outSQL = getCountSQL(inKey.isDistinct()) + 
	 ...
	 * @throws org.hip.kernel.bom.BOMException
	 */
	public String createCountSQL(KeyObject inKey, HavingObject inHaving, GroupByObject inGroupBy, GeneralDomainObjectHome inHome) throws BOMException {
		String outSQL = getCountSQL(inKey.isDistinct()) + 
			createSQLWhere(getWhereAdder(), inKey, inHome) +
	...
	/**
	 * Different DBs add the SQL WHERE clause using different terms.
	 * Hook for subclasses.
	 * 
	 * @return String
	 */
