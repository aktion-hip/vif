...
public class UpdateStatement extends CommittableStatement {
	...
	// Instance variables
	private Collection<String> updates	= null;
	 ...
	 */
	public UpdateStatement(GeneralDomainObjectHome inHome) {
		super();
	 ...
	 *  by setting a Vector of SQL update statements (SQL strings).
	 * 
	 * 	@param inUpdates java.util.Collection
	 */
	public void setUpdates(Collection<String> inUpdates) {
		updates = inUpdates;
	}
