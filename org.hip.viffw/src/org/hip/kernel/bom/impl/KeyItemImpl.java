...
/**
 * 	This is the default implementation of the KeyItem
 *	interface.
 *
...
public class KeyItemImpl extends AbstractNameValue implements KeyItem {
	 ...
	 */
	public KeyItemImpl(NameValueList inKey, String inName) {
	 ...
	 */
	protected void checkName(String name) throws VInvalidNameException {
	 ...
	 */
	protected void checkValue(Object value) throws VInvalidValueException {
		// Actually no constraints defined
	}
}
