 ...
 * This serializer ignores this formating and returns cleaned text.
 * 
...
public class IgnoringSTFormatSerializer extends AbstractStructuredTextSerializer {
	 ...
	 * @param inLevel
	 */
	public IgnoringSTFormatSerializer(int inLevel) {
		super(inLevel);
	}
	 ...
	 * @param inFilter
	 */
	public IgnoringSTFormatSerializer(int inLevel, XMLCharacterFilter inFilter) {
	 ...
	 * @param inFilter
	 */
	public IgnoringSTFormatSerializer(XMLCharacterFilter inFilter) {
		super(inFilter);
	}
	 ...
	 * org.hip.kernel.stext.IgnoringFormatSerializer.
	 * 
