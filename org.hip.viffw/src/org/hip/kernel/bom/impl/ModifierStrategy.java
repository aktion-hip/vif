...
/**
 * This strategy class can be used to create SQL SELECT statments with column modifiers, 
 * e.g. to retrieve the maximum or average value of a column.
 * 
...
public class ModifierStrategy extends VObject {
	...
	/**
	 * ModifierStrategy constructor.
	 * Use this constructor to modify all columns in the same way.
	 * 
	 ...
	 */
	public ModifierStrategy(String inColumnName, int inModifier) {
	 ...
	 */
	public ModifierStrategy(String[] inColumnNames, int inModifier) {
		super();
	...
	/**
	 * ModifierStrategy constructor.
	 * Use this constructor if the different columns are modified differently.
	 * Both arrays passed as parameters must be of equal length.
	 * 
	 * @param inColumnNames String[] The name of the columns that shall be modified.
	 * @param inModifiers int[] The modifiers to apply to the columns.
	 */
	public ModifierStrategy(String[] inColumnNames, int[] inModifiers) {
		super();
		columnNames = inColumnNames;
		modifiers = initModifiers(inColumnNames.length);
		try {
	...
	private String[] initModifiers(int inLength) {
		String[] outModifiers = new String[inLength];
		Arrays.fill(outModifiers, MODIFIERS[MAX]);
		return outModifiers;
	}
	
	/**
	 * Creates the SQL statement with the modified column names, e.g.
	 * "MAX(pressure), AVG(pressure)"
	 * 
	 * @param inDomainObjectHome DomainObjectHome
	 * @return StringBuffer The SQL with the modified columns
	 */
	public StringBuffer createModifiedSQL(DomainObjectHome inDomainObjectHome) {
