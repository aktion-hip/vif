...
/**
 * This interface defines a stack of criteria and operators.
 * The aim of this interface is the correct rendering of a sequence of criteria and operators
 * placing the brackets so that a logical correct statement is created which has the intended effect,
 * e.g. ((crit1 AND crit2 AND crit3) OR crit4)
 *
 * @author Luthiger
