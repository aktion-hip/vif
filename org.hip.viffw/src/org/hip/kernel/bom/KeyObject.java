...
/**
 * KeyObjects are used to find DomainObjects.
 * They are a special form of a SortedList list. They hold list items 
 * (i.e. select criteria) in the order they have added to the KeyObject.
 *
...
public interface KeyObject extends SortedList {
	public enum BinaryBooleanOperator {
		AND {
			public String render() {return "AND";};
			public String getPrefixOperand() {return "&";}
		}, 
		OR {
			public String render() {return "OR";};
			public String getPrefixOperand() {return "|";}
		}, 
		XOR {			
			public String render() {return "XOR";};
			public String getPrefixOperand() {return "|";}
		};		
	 ...
	 * @throws org.hip.kernel.util.VInvalidValueException
	 */
	void setValue(String inName, Object inValue, String inComparison) throws VInvalidNameException, VInvalidValueException;
	 ...
	 * @throws org.hip.kernel.util.VInvalidNameException
	 * @throws org.hip.kernel.util.VInvalidValueException
	 * @deprecated use setValue(String inName, Object inValue, String inComparison, BinaryBooleanOperator inBinaryOperator) instead
	 */
	void setValue(String inName, Object inValue, String inComparison, boolean inLinkType) throws VInvalidNameException, VInvalidValueException;
	/**
	 ...
	 */
	void setValue(String inName, Object inValue, String inComparison, BinaryBooleanOperator inBinaryOperator) throws VInvalidNameException, VInvalidValueException;
	 ...
	 * @throws org.hip.kernel.util.VInvalidNameException
	 * @throws org.hip.kernel.util.VInvalidValueException
	 * @deprecated use setValue(String inName, Object inValue, String inComparison, BinaryBooleanOperator inBinaryOperator, ColumnModifier inColumnModifier) instead
	 */
	void setValue(String inName, Object inValue, String inComparison, boolean inLinkType, ColumnModifier inColumnModifier) throws VInvalidNameException, VInvalidValueException;
	/**
	 ...
	 * @throws VInvalidValueException
	 */
	void setValue(String inName, Object inValue, String inComparison, BinaryBooleanOperator inBinaryOperator, ColumnModifier inColumnModifier) throws VInvalidNameException, VInvalidValueException;
	 ...
	 * @throws VInvalidValueException
	 */
	void setValue(KeyObject inKey, BinaryBooleanOperator inBinaryOperator) throws VInvalidNameException, VInvalidValueException;
	...
	/**
	 * Sets the factory that creates the stack instances defining how the sequence of 
	 * criteria and operators is rendered.
	 * 
