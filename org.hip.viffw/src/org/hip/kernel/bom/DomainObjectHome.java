...
/**
 * This interface defines the responsibilities of "Homes".
 * Conceptually, this Home and all subclasses are similar
 * the EJBHome.
 *
 * @author Benno Luthiger
 */
public interface DomainObjectHome extends GeneralDomainObjectHome {
	
	Hashtable<String, String> tableNames();
