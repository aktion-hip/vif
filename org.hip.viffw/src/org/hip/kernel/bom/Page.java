...
/**
 * 	The Page is a special object that can be accessed by
...
public interface Page {
	...
	// class variables
	public int DEFAULT_PAGE_SIZE = 5;
	
	/**
	 * 	Returns the next page. It will return itself if
	 *  it is the lastPage.
	...
	/**
	 * 	Returns the previous page. It returns itself if it is
	 *  the first page.
	 * 	@return org.hip.kernel.bom.Page
	 */
