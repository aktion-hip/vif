...
/**
 * 	The HomeManager is responsible to instantiate homes. The
 * 	singleton can be access by the global variable VSys.homeManager
 *
 *	<PRE>
 *		PersonHome 	home 	= VSys.homeManager.getHome( "org.hip.kernel.bom.PersonHome" ) ;
 *		Person 		person 	= home.findByPrimaryKey( "Müller" ) ;
 *
 *	</PRE>
 *
