...
/**
 * 	The MetaModelHome is responsible to create
 *	and manage MetaModelObjects.
 * 
 * 	@author		Benno Luthiger
 */
public interface MetaModelHome extends Home {
	
	public final String OBJECT_DEF_DEF 			= "ObjectDefDef".intern()			;
	public final String PROPERTY_DEF_DEF 		= "PropertyDefDef".intern()			;
	public final String PROPERTY_SET_DEF_DEF 	= "PropertySetDefDef".intern()		;
	public final String MAPPING_DEF_DEF 		= "MappingDefDef".intern()			;
	public final String KEY_DEF_DEF 			= "KeyDefDef".intern()				;
	public final String JOIN_DEF_DEF			= "JoinDefDef".intern();
	public final String JOINED_OBJECT_DEF_DEF	= "JoinedObjectDefDef".intern();
	public final String GROUPING_DEF_DEF		= "GroupingDefDef".intern();
	public final String NESTED_DEF_DEF			= "NestedDefDef".intern();
	...
	MetaModelHome singleton	= MetaModelHomeImpl.getSingleton();
