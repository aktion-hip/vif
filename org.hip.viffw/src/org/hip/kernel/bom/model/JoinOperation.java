 ...
 * <pre>tblTextVersion INNER JOIN tblTextAuthorReviewer ON tblTextVersion.TEXTID = tblTextAuthorReviewer.TEXTID</pre>
 * <pre>leftTable JoinType rightTable ON leftOperand = rightOperand</pre>
 * 
