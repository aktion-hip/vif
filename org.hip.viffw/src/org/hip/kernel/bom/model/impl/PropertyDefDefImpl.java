 ...
 */
public class PropertyDefDefImpl extends AbstractMetaModelObject implements PropertyDefDef {
	
	private static Object[][] 	def = {
			{ PropertyDefDef.propertyName	, "java.lang.String"							}
	...
	/**
	 * PropertyDefDefImpl default constructor.
	 */
	public PropertyDefDefImpl() {
		super();
	}
	/**
