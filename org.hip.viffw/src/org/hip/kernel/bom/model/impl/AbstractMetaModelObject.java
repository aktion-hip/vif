...
/**
 * 	This is the base abstract implementation of the MetaModelObject
 *	interface.
 * 
 * 	@author		Benno Luthiger
 * 	@see		org.hip.kernel.bom.model.MetaModelObject
 */
abstract public class AbstractMetaModelObject extends AbstractSemanticObject implements MetaModelObject {
/**
 * AbstractMetaModelObject default constructor.
 */
public AbstractMetaModelObject() {
	super();
}
/**
 ...
 */
public synchronized void initializePropertySet( PropertySet inSet ) {
	
	Object[][] lDef = getConstantDef() ;
