...
/**
 * The interface JoinDef defines the behaviour of
 * join definition objects in joined domain objects.
 * 
 * @author Benno Luthiger
 */
public interface JoinDef extends ModelObject {
	public static final String DFT_JOIN_TYPE = "EQUI_JOIN";
	public static final String NO_JOIN_TYPE = "NO_JOIN";
