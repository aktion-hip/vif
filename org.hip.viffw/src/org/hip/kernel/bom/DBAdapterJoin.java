...
/**
 * Interface for Adapter classes for joined domain objects.
 ...
 */
public interface DBAdapterJoin {
	 ...
	 * <b>Note</b>: To specify a clause only using e.g. the HAVING part, you can
	 ...
	 * @throws BOMException
	 */
	String createSelectSQL(KeyObject inKey, OrderObject inOrder, HavingObject inHaving, GeneralDomainObjectHome inHome) throws BOMException;
	String createSelectSQL(KeyObject inKey, OrderObject inOrder, HavingObject inHaving, GroupByObject inGroupBy, GeneralDomainObjectHome inHome) throws BOMException;
	...
	String createCountSQL(KeyObject inKey, HavingObject inHaving, GroupByObject inGroupBy, GeneralDomainObjectHome inHome) throws BOMException;
