 ...
 */
abstract public class AbstractNameValueListVisitor extends VObject implements NameValueListVisitor {

	// Instance valiables
	protected String externalized = "";
	
	/**
	 * AbstractNameValueListVisitor default constructor.
	 */
	public AbstractNameValueListVisitor() {
		super();
	}
