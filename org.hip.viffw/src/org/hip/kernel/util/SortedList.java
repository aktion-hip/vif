...
/**
 * The SortedList holds a sorted collection of SortableItems.
 * This list has no dupblicate elements.
 * 
...
public interface SortedList extends Serializable {
	 ...
	 * 
	 * @return TreeSet<SortableItem>
	 */
	TreeSet<SortableItem> getItems2();
