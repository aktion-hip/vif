...
public class UmlautChange {
	...
	private static Object[][] umlauts = { { new Character("ä".charAt(0)), "ae" }
		                                ...
		                                , { new Character("Ö".charAt(0)), "Oe" }
		                                , { new Character("Ü".charAt(0)), "Ue" } };
	private static Hashtable<Object, Object> umlautsTable = null;
	 ...
	 */
	public static synchronized String convert(String inName) {
		StringBuilder out = new StringBuilder();
		for (int i = 0; i < inName.length(); i++ ) {
			Character lChar = new Character(inName.charAt(i));
	 ...
	 */
	private static Hashtable<Object, Object> getUmlauts() {
		if (umlautsTable == null) {
			umlautsTable =  new Hashtable<Object, Object>(11);
