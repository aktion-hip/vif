 ...
 */
public class WorkflowError extends Error {
	 ...
	 * @param inMessage
	 */
	public WorkflowError(String inMessage) {
		super(inMessage);
	}
	 ...
	 * @param inCause
	 */
	public WorkflowError(Throwable inCause) {
		super(inCause);
	}
	 ...
	 * @param inCause
	 */
	public WorkflowError(String inMessage, Throwable inCause) {
