...
public interface ExceptionHandler {
	...
	//class attributes
	public static ExceptionHandler cDefaultHandler 			= DefaultExceptionHandler.instance() ;
	public static ExceptionHandler cDefaultRuntimeHandler 	= DefaultRuntimeExceptionHandler.instance() ;
	public static ExceptionHandler cDefaultErrorHandler 	= DefaultErrorHandler.instance() ;
	...
	/**
	 * 	Subclasses must implement this method. The interface makes no
	 *  assumptions about the concrete handling.
	 * 
	 * @param 	throwable 		java.lang.Throwable 
	 *			The Error or Exception to handle
	 * @param 	printStackTrace boolean 
	 *			Flag to control the output of the stack trace.
	 */
