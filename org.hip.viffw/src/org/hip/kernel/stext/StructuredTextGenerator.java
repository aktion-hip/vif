...
/**
 * This class generates StructuredText classes out of strings which are formatted
 * according to structured text rules.
 * 
 * @author: Benno Luthiger
 */
public class StructuredTextGenerator {
	private static StructuredTextGenerator singleton = null;
	 ...
	 */
	public static StructuredTextGenerator getSingleton() {
		if (singleton == null)
	 ...
	 */
	public StructuredText createStructuredText(String inRawString) {
		String[] lParagraphs = createParagraphs(inRawString);
		return new StructuredText(lParagraphs);
	}
	
	private String[] createParagraphs(String inRawString) {
