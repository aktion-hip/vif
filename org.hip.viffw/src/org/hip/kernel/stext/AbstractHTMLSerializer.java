...
/**
 * This class provides generic functionality to create html code 
 * by serializing a StructuredText.
 * 
 * @see org.hip.kernel.stext.StructuredTextSerializer
 * @see org.hip.kernel.stext.StructuredText
 * @author: Benno Luthiger
 */
public abstract class AbstractHTMLSerializer extends AbstractStructuredTextSerializer implements StructuredTextSerializer {
	// Instance variables
	private boolean inList = false;

	/**
	 * Constructor for AbstractHTMLSerializer.
	 */
	public AbstractHTMLSerializer() {
		super();
	}
