...
/**
 * A tuple stores both any object in the first position and a BitRow in the
 * second position.
 * 
...
public class Tuple extends VObject implements Cloneable {
	 ...
	 */
	public Tuple(Object inObject, BitRow inRow) {
		super();
	 ...
	 * @return org.hip.kernel.bitmap.Tuple
	 */
	public Tuple and(Tuple inTuple) {
	 ...
	 * @return org.hip.kernel.bitmap.Tuple
	 */
	public Tuple xor(Tuple inTuple) {
	 ...
	 */
	public Object clone() {
		return new Tuple(tupleObject, (BitRow)tupleBitRow.clone());
	}
}
