...
public class AutoCompleteHelperTest {
	...
	public final void testTitlesContainer() throws Exception {
		AutoCompleteHelper lHelper = new AutoCompleteHelper(data.getTextHome(), new KeyObjectImpl());
		
		IndexedContainer lTitlesContainer = lHelper.getTitlesContainer();
		Collection<?> lTitles = lTitlesContainer.getItemIds();
		...
		IndexedContainer lAuthorsContainer = lHelper.getAuthorsContainer();
		Collection<?> lAuthors = lAuthorsContainer.getItemIds();
