...
public class VIFAuthorizationTest {
	...
	public void testDo() throws Exception {
		...
		VIFAuthorization lAuthorization1 = new VIFAuthorization(lMemberIDs[0]);
		VIFAuthorization lAuthorization2 = new VIFAuthorization(lMemberIDs[1]);
		assertTrue("check role 1", lAuthorization1.checkRoles(new String[] {String.valueOf(RolesConstants.SU)}));
		assertTrue("check role 2", lAuthorization1.checkRoles(new String[] {String.valueOf(RolesConstants.MEMBER), String.valueOf(RolesConstants.SU)}));
		assertTrue("check role 3", !lAuthorization1.checkRoles(new String[] {String.valueOf(RolesConstants.MEMBER)}));
		assertTrue("check role 4", lAuthorization2.checkRoles(new String[] {String.valueOf(RolesConstants.GROUP_ADMINISTRATOR)}));
		assertTrue("check role 5", lAuthorization2.checkRoles(new String[] {}));
		
		assertTrue("check permission 1", lAuthorization1.checkPermissions(new String[] {DataHouseKeeper.PERMISSION_LABEL_1}));
		assertTrue("check permission 2", lAuthorization1.checkPermissions(new String[] {DataHouseKeeper.PERMISSION_LABEL_1, DataHouseKeeper.PERMISSION_LABEL_2}));
		assertTrue("check permission 3", lAuthorization1.checkPermissions(new String[] {DataHouseKeeper.PERMISSION_LABEL_2}));
		assertTrue("check permission 4", !lAuthorization1.checkPermissions(new String[] {"dummy"}));
		assertTrue("check permission 5", lAuthorization2.checkPermissions(new String[] {DataHouseKeeper.PERMISSION_LABEL_1}));
		assertTrue("check permission 6", !lAuthorization2.checkPermissions(new String[] {DataHouseKeeper.PERMISSION_LABEL_2}));
...
//		String[] lPermissions = lAuthorization1.getPermittedPermissions();
		Collection<String> lVPermissions = lAuthorization1.getPermissions();
		...
		VIFAuthorization lAuthorization3 = new VIFAuthorization(lMemberIDs[0]);
	...
	private void assertCollection(String[] inExpected, Collection<String> inActual) {
		for (String lExpected : inExpected) {
