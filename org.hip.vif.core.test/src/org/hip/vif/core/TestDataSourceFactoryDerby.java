...
public class TestDataSourceFactoryDerby implements DataSourceFactory {
    ...
    @Override
    public DataSource createDataSource(final Properties inProperties) throws SQLException {
    ...
    @Override
    public ConnectionPoolDataSource createConnectionPoolDataSource(final Properties inProperties) throws SQLException {
    ...
    @Override
    public XADataSource createXADataSource(final Properties inProperties) throws SQLException {
    ...
    @Override
    public Driver createDriver(final Properties inProperties) throws SQLException {
