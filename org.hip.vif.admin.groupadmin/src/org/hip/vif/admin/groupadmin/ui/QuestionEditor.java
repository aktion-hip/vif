...
public class QuestionEditor extends AbstractQuestionView {
	...
	/**
	 * Constructor to edit an existing question (called from edit button on
	 * <code>QuestionView</code>).
	 * 
	 * @param inGroup
	 *            {@link Group}
	 * @param inQuestion
	 *            {@link Question}
	 * @param inCompletions
	 *            {@link List} of <code>Completion</code>s
	 * @param inBibliography
	 *            {@link QueryResult}
	 * @param inCodeList
	 *            {@link CodeList}
	 * @param inAdminQuestionEditTask
	 *            {@link AbstractQuestionTask}
	 * @throws SQLException
	 * @throws VException
	 */
	public QuestionEditor(final Group inGroup, final Question inQuestion,
		...
		lLayout.addComponent(new Label(String.format(VIFViewHelper.TMPL_TITLE,
				"vif-title", lLabel), ContentMode.HTML)); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @param inRemark
	 *            String
	 * @param inParentQuestion
	 *            {@link Question} must not be <code>null</code>
	 * @param inGroup
	 *            {@link Group}
	 * @param inCompletions
	 *            {@link QueryResult} the parent question's completions
	 * @param inBibliography
	 *            {@link QueryResult} the parent question's texts
	 * @param inAuthors
	 *            {@link QueryResult} the parent question's authors
	 * @param inReviewers
	 *            {@link QueryResult} the parent question's reviewers
	 * @param inCodeList
	 *            {@link CodeList}
	 * @param inTask
	 * @throws VException
	...
	private VerticalLayout createLayout(final Group inGroup,
		...
		final String lTitle = inMessages.getFormattedMessage(
				"ui.discussion.question.view.title.activ", //$NON-NLS-1$
