...
public class CompletionView extends AbstractContributionView {
	...
	public CompletionView(final Completion inCompletion,
		...
		final String lSubTitle = String.format(lMessages.getFormattedMessage(
				"ui.discussion.completion.title", //$NON-NLS-1$
		...
		lLayout.addComponent(new Label(String.format(VIFViewHelper.TMPL_TITLE,
				"vif-title", lSubTitle), ContentMode.HTML)); //$NON-NLS-1$
	...
	public CompletionView(final String inCompletion, final Long inCompletionID,
		...
		final String lSubTitle = String.format(lMessages.getFormattedMessage(
				"ui.discussion.completion.title.create", //$NON-NLS-1$
				BeanWrapperHelper.getPlain(QuestionHome.KEY_QUESTION_DECIMAL,
						inQuestion)));
		lLayout.addComponent(new Label(String.format(VIFViewHelper.TMPL_TITLE,
				"vif-title", lSubTitle), ContentMode.HTML)); //$NON-NLS-1$
	...
	private VerticalLayout createLayout(final Group inGroup,
		...
		final String lTitle = String.format(inMessages.getFormattedMessage(
