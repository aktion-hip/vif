...
/**
 * Task to edit questions (called from edit button on <code>QuestionView</code>
 * ).<br />
 * The display should resemble as much as possible the question show view. We
 * only set the question and remark texts in editable fields.
 * 
		...
		try {
			...
			showNotification(
					Activator.getMessages().getMessage(
							"errmsg.question.published"), Notification.Type.WARNING_MESSAGE); //$NON-NLS-1$
