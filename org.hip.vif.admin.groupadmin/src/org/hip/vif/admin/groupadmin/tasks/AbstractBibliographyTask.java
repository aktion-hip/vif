...
public abstract class AbstractBibliographyTask extends AbstractWebController // NOPMD
implements IBibliographyTask {
    ...
    protected Component editBibliography(final Text inText,
            ...
            final boolean inCreateVersion) throws SQLException, VException {
    ...
    /** @param inTextID Long
     * @param inTextVersion int
     * @return {@link QueryResult} the entry of the author responsible for the specified text version
     * @throws VException
     * @throws SQLException */
    ...
    /** @param inTextID Long
     * @param inTextVersion int
     * @return {@link QueryResult} the entry of the reviewer responsible for the specified text version
     * @throws VException
     * @throws SQLException */
    ...
    public Long saveFileUpload(final File inTempUpload,
        ...
        try {
            final IDownloadTextValues lDownloadValues = new BibliographyHelper.DownloadTextValues(
                    inTempUpload, inFileName, inMimeType, getTextIDChecked(), getActor().getActorID());
    ...
    public boolean saveText(final Text inText, final boolean inCreateVersion) {
        try {
            ...
            showNotification(Activator.getMessages().getMessage("msg.bibliography.create")); //$NON-NLS-1$
