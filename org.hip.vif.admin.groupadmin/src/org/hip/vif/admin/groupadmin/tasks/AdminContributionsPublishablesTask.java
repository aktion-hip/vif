...
/**
 * Task for group administrators to display the contributions they created for
...
public class AdminContributionsPublishablesTask extends AbstractWebController
	...
	public boolean publishContributions() {
		...
		try {
			...
			String lMessage = lMessages.getFormattedMessage(
					"admin.msg.contributions.publish", lNumberOfPublished); //$NON-NLS-1$
	 ...
	 * Displays the selected contribution in edit mode.
	 */
	@Override
