...
public class GroupExtentTest {
	...
	public void testCreation() throws Exception {
		...
		Long lGroupID = data.createGroup();
 	 	...
 	 	Long lQuestionID1 = createQuestion(lQuestion1, "1:1", lGroupID, true, lAuthorIDs[0]);
		createQuestion(lQuestion2, "1:1.1", lGroupID, false, lAuthorIDs[1]);
		Long lQuestionID3 = createQuestion(lQuestion3, "1:1.2", lGroupID, false, lAuthorIDs[0]);
	...
	private Long createQuestion(String inQuestion, String inDecimal, Long inGroupID, boolean isRoot, String inAuthorID) throws VException, SQLException, WorkflowException {
		Long outQuestionID = data.createQuestion(inQuestion, inDecimal, inGroupID, isRoot);
