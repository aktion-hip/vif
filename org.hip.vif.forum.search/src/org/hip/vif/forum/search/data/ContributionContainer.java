...
public class ContributionContainer extends BeanItemContainer<ContributionWrapper> {
    public static final Object[] NATURAL_COL_ORDER = new Object[] { "decimalID", "question", "author", "group" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    public static String[] COL_HEADERS = new String[] {
        "ui.search.view.table.decimal", "ui.search.view.table.question", "ui.search.view.table.author", "ui.search.view.table.group" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
     ...
     * @throws VException
     * @throws SQLException */
    public static ContributionContainer createData(final QueryResult inSearchResult) throws VException, SQLException {
