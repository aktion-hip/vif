...
public class GroupWrapper implements ISelectableBean {
	...
	private Integer guestDepth;
	private Integer minGroupSize;
	private String state;
	private boolean isDeletable;
	private boolean checked;

	private GroupWrapper(GeneralDomainObject inDomainObject, CodeList inCodeList, QuestionHome inQuestionHome) throws VException, SQLException {
	 ...
	 * @throws VException 
	 */
	public static GroupWrapper createItem(GeneralDomainObject inGroup, CodeList inCodeList, QuestionHome inQuestionHome) throws VException, SQLException {
