...
public class ParticipantBean extends MemberBean {
    ...
    private final Integer groupAdminID;
    private final Integer suspendFrom;
    private final Integer suspendTo;

    private ParticipantBean(final GeneralDomainObject inDomainObject) {
    ...
    public static ParticipantBean createItem(final GeneralDomainObject inParticipant) {
