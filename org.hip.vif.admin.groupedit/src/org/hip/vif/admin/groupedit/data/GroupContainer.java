...
public class GroupContainer extends BeanItemContainer<GroupWrapper> {
    ...
    public static final Object[] NATURAL_COL_ORDER = new Object[] { GROUP_CHECK,
        "name", "description", "numberOfReviewers", "guestDepth", "minGroupSize", "state" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    public static final String[] COL_HEADERS = new String[] {
        "", "container.group.headers.name", "container.group.headers.description", "container.group.headers.number.of", "container.group.headers.guest.depth", "container.group.headers.min.group.size", "container.group.headers.state" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
     ...
     * @throws VException
     * @throws SQLException */
    public static GroupContainer createData(final QueryResult inResult, final CodeList inCodeList) throws VException,
    SQLException {
