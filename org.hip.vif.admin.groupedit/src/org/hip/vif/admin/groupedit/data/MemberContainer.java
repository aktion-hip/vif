...
public class MemberContainer extends BeanItemContainer<MemberBean> {
	...
	public static final String[] NATURAL_COL_ORDER = new String[] {MEMBER_CHECK, "userID", "name", "mail"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	public static String[] COL_HEADERS = new String[] {"", "container.member.headers.userid", "container.member.headers.name", "container.member.headers.mail"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
