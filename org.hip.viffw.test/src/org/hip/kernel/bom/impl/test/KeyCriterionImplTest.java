...
public class KeyCriterionImplTest {
	...
	public void testRender() throws VException {
		...
		lCriterion = new KeyCriterionImpl(Test2DomainObjectHomeImpl.KEY_MUTATION, lBetween, "", BinaryBooleanOperator.AND, KeyCriterionImpl.COLUMN_MODIFIER_DFT);
		assertEquals("render 4", 
				"tblTest.DTMUTATION BETWEEN DATE('1989-08-20') AND DATE('1999-04-24')", 
				new String(lCriterion.render(lHome)));
		
		@SuppressWarnings("rawtypes")
		InObjectImpl lIn = new InObjectImpl(new Object[] {new Integer(10), new Integer(13), new Integer(16), new Integer(20)});
		lCriterion = new KeyCriterionImpl(Test2DomainObjectHomeImpl.KEY_AMOUNT, lIn, "", BinaryBooleanOperator.AND, KeyCriterionImpl.COLUMN_MODIFIER_DFT);
	...
	public void testRender2() throws VException {
		...
		KeyCriterion lCriterion = new KeyCriterionImpl(createKeyLDAP(), BinaryBooleanOperator.AND);
