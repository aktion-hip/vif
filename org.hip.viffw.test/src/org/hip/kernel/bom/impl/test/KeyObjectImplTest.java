...
public class KeyObjectImplTest {
	...
	public void testCreate() throws VException {
		...
		assertEquals("key 1", "tblTest.FAMOUNT = 12", new String(lKey1.render(lHome)));
		...
		assertEquals("key 4", "", new String(lKey4.render(lHome)));
		...
		assertEquals("key 5", 
				...
				new String(lKey.render(lHome)));
		
		lKey = new KeyObjectImpl();
		SQLRange lIn = new InObjectImpl<Integer>(new Integer[] {new Integer(65), new Integer(77), new Integer(87), new Integer(99)});
		...
		Vector<Integer> lValues = new Vector<Integer>();
		...
		assertEquals("tblTest.FAMOUNT IN (65, 77, 87, 99)", new String(lKey.render(lHome)));
	}
	...
	public void testRenderPrepared() throws VException {
		DomainObjectHome lHome = data.getSimpleHome();
		IGetValueStrategy lGetValueStrategy = new PreparedValueStrategy();
		
		KeyObject lKey1 = new KeyObjectImpl();
		lKey1.setValue(Test2DomainObjectHomeImpl.KEY_AMOUNT, new Integer(12));
		lKey1.setGetValueStrategy(lGetValueStrategy);
		assertEquals("key 1", "tblTest.FAMOUNT = ?", new String(lKey1.render(lHome)));
	...
	public void testSort() throws VException {
		String[] lExpected = {"field1", "__keyObject(VIF)", "field2", "field3"};
		KeyObject lKey = new KeyObjectImpl();
		lKey.setValue(lExpected[0], new Integer(12), "=", BinaryBooleanOperator.AND);
		KeyObject lKeyInner = new KeyObjectImpl();
