...
public class LoadedPermissionContainer extends BeanItemContainer<LoadedPermissionBean> {
	...
	public static final String[] NATURAL_COL_ORDER = new String[] {"", FIELD_LABEL, FIELD_ROLE_SU, FIELD_ROLE_ADMIN, FIELD_ROLE_GROUPADMIN, FIELD_ROLE_PARTICIPANT, FIELD_ROLE_MEMBER, FIELD_ROLE_GUEST, FIELD_ROLE_EXCLUDED}; //$NON-NLS-1$
	 ...
	 * @throws SQLException
	 */
	public static LoadedPermissionContainer createData(QueryResult inPermissions, Collection<AlternativeModel> inAssociations) throws VException, SQLException {
		LoadedPermissionContainer outData = new LoadedPermissionContainer();
