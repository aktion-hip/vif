...
/** The menu item <code>Manage User</code>.
 *
 * @author lbenno */
public class ManageUserMenu implements IExtendibleMenuContribution {

    @Override
    public String getLabel() {
        return Activator.getMessages().getMessage("usersettings.menu.open.tasks"); //$NON-NLS-1$
    }

    @Override
    public String getControllerName() {
        return UseCaseHelper.createFullyQualifiedControllerName(UserTasksManageTask.class);
    }
