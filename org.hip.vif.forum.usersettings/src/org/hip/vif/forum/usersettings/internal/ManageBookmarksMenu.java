...
/** The menu item <code>Manage Bookmarks</code>.
 *
 * @author lbenno */
public class ManageBookmarksMenu implements IExtendibleMenuContribution {

    @Override
    public String getLabel() {
        return Activator.getMessages().getMessage("usersettings.menu.bookmarks"); //$NON-NLS-1$
    }

    @Override
    public String getControllerName() {
        return UseCaseHelper.createFullyQualifiedControllerName(BookmarksManageTask.class);
    }
