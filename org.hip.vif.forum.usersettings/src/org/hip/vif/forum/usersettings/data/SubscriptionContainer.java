...
public class SubscriptionContainer extends BeanItemContainer<SubscriptionBean> {
    ...
    public static final Object[] NATURAL_COL_ORDER = new Object[] { ITEM_CHK, ITEM_LOCAL,
            "questionDecimal", "questionText" }; //$NON-NLS-1$ //$NON-NLS-2$
    public static final String[] COL_HEADERS = new String[] {
            "", "ui.usersettings.data.column.local", "ui.usersettings.data.column.number", "ui.usersettings.data.column.question" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
     ...
     * @throws VException
     * @throws SQLException */
    public static SubscriptionContainer createData(final QueryResult inSubscriptions) throws VException, SQLException {
        final SubscriptionContainer outData = new SubscriptionContainer();
