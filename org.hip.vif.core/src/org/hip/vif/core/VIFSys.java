...
public final class VIFSys extends VSys {
    ...
    /** a default Locale */
    private static final Locale cDefaultLocale = new Locale(dftLanguage, ""); // NOPMD
    ...
    public static void configureVSys() {
        ...
        final String lConfigPath = new File("").getAbsolutePath();
    ...
    public static ResourceBundle getErrMessageBundle(final String inLanguage) {
    ...
    public static ResourceBundle getErrMessageBundle(final Locale inLocale) {
    ...
    public static String getErrorMessage(final String inId) {
     ...
     * @param inLanguage java.lang.String the desired language
     * @param inId java.lang.String */
    public static String getErrorMessage(final String inLanguage, final String inId) {
     ...
     * @param inId java.lang.String
     * @param inLocale java.util.Locale the desired locale */
    public static String getErrorMessage(final Locale inLocale, final String inId) {
     ...
     * @param inArgs Object[]
     * @return String */
    public static String getFormattedErrorMessage(final String inId, final Object... inArgs) {
     ...
     * @param inArgs Object[]
     * @return String */
    public static String getFormattedErrorMessage(final String inLanguage, final String inId, final Object... inArgs) {
     ...
     * @param inLanguage java.lang.String The desired language
     * @param inId java.lang.String */
    public static String getMessage(final String inLanguage, final String inId) {
        return "";
     ...
     * @param inArgs Object[]
     * @return String */
    public static String getFormattedMessage(final String inId, final Object... inArgs) {
     ...
     * @param inArgs Object[]
     * @return String */
    public static String getFormattedMessage(final String inLanguage, final String inId, final Object... inArgs) {
     ...
     * @return java.util.ResourceBundle
     * @param inLanguage java.lang.String the desired language */
    public static ResourceBundle getMessageBundle(final String inLanguage) {
     ...
     * @return java.util.ResourceBundle
     * @param inLocale java.util.Locale the desired locale */
    public static ResourceBundle getMessageBundle(final Locale inLocale) {
