...
public class ApplicationData implements TransactionListener, Serializable {
    ...
    public static void create(final Application inApplication) {
        final ApplicationData lSessionData = new ApplicationData();
        instance.set(lSessionData);
        inApplication.getContext().addTransactionListener(lSessionData);
    }

    /** Initializes the <code>ResourceBundle</code> for the i18n messages. This method has to be called in the
     * application's init method and whenever the user changes the locale.
     * 
     * @param inLocale {@link Locale} */
    public static void initLocale(final Locale inLocale) {
    ...
    public void transactionStart(final Application inApplication, final Object inTransactionData) {
        instance.set(this);
    }

    public void transactionEnd(final Application inApplication, final Object inTransactionData) {
        instance.set(null);
    }
    ...
    public static void setActor(final IActor inActor) {
    ...
    public static void setGroupID(final Long inGroupID) {
    ...
    public static void setQuestionID(final Long inQuestionID) {
    ...
    public static void setCompletionID(final Long inCompletionID) {
    ...
    public static void setTextID(final Long inTextID) {
    ...
    public static void setTextVersion(final String inTextVersion) {
        try {
    ...
    /** Set's a generic <code>ParameterObject</code> to the application context. <br/>
     * Use e.g.:
     * 
     * <pre>
    ...
    public static void setRequestURL(final String inRequestURL) {
    ...
    public static void setWindow(final Window inWindow) {
    ...
    public static IPluggableTask pushToHistory(final IPluggableTask inTask) {
    ...
    public static void setMenuMap(final Map<String, MenuItem> inMenuMap) {
        instance.get().menuMap = inMenuMap;
    }

    /** Sets the bundle's menu item active.<br />
     * Each bundle is providing its menu entries. The menu can be styled to indicate the active menu (style
     * <code>vif-menu-active</code>), i.e. the menu from the bundle of the task actually processed.
     * 
    ...
    public static void setActiveMenuItem(final String inBundleName) {
        ...
        final MenuItem lNewItem = instance.get().menuMap.get(inBundleName);
        if (lNewItem != null) {
