...
/**
 * A member domain object backed by a lucene Document object.
...
public class MemberHitsObject extends AbstractHitsDomainObject {
	...
	static {
		for (AbstractSearching.IndexField lField : AbstractSearching.MEMBER_FIELDS) {
	 ...
	 * @param inDocument
	 */
	public MemberHitsObject(Document inDocument) {
		super(inDocument);
	}
