...
public abstract class AbstractVIFIndexer extends AbstractSearching {
    ...
    private int indexEntries(final QueryResult inResult, final IndexWriter inWriter) throws VException, SQLException,
            IOException {
        int outNumberOfIndexed = 0;
     ...
     * @throws SQLException
     * @throws VException */
    protected void addEntryToIndex(final GeneralDomainObjectHome inHome, final KeyObject inKey) throws IOException,
