 ...
 *
 * <p>
 * Deprecated: use <code>org.hip.vif.web.mail.AbstractMail</code> instead. Created on 14.08.2003
 * 
 * @author Luthiger */
@Deprecated
public abstract class AbstractMail extends VObject implements IVIFMail {
     ...
     * @throws VException
     * @throws IOException */
    public AbstractMail(final VIFMember inReceiver) throws VException, IOException {
        super();
     ...
     * @throws VException
     * @throws IOException */
    public AbstractMail(final VIFMember inReceiver, final VIFMember inSender) throws VException, IOException {
        super();
        init(inReceiver, inSender);
    }

    private void init(final VIFMember inReceiver, final VIFMember inSender) throws VException, IOException {
        receiver = inReceiver;
    ...
    public void send() throws MailGenerationException {
        try {
            final StringBuilder lSubject = new StringBuilder(subjectID).append(" ").append(getSubjectText());
     ...
     * @param inMsgId java.lang.String
     * @param inArg Object */
    protected String getFormattedMessage(final IMessages inMessages, final String inKey, final Object... inArgs) {
