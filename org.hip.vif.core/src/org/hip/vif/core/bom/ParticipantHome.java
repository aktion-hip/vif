...
/**
 * ParticipantHome is responsible to manage instances
 * of class org.hip.vif.bom.Participant
 * 
...
public interface ParticipantHome extends DomainObjectHome {
	 ...
	 * @return Collection<Long> the groups the user tried to unregister but she's not allowed to do this because she's administering the group 
