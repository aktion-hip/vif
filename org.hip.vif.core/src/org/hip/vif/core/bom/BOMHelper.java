...
public final class BOMHelper {
	...
	/**
	 * Returns the MemberHome for the <code>Member</code> objects the user are
	 ...
	 * 
	 * @param inFindValue
	 *            java.lang.String The value which identifies externally the
	 *            newly created DomainObject
	 * @param inFindKey
	 *            java.lang.String The field name of external identification
	 * @param inHome
	 *            org.hip.kernel.bom.DomainObjectHome The home managing the
	 *            newly created DomainObject
	 * @param inIDKey
	 *            java.lang.String The field name which identifies internally
	 *            the DomainObject
	 */
	...
	/**
	 * Returns a KeyObject to select entries with the specified states, i.e.
	 * which creates the SQL string '(FIELD_STATE = inState1 OR FIELD_STATE =
	 * inState2)'
	 * 
	 * @param inFieldState
	 *            String name of the state field
	 * @param inStates
	 *            Integer[] the states the selected entries must have
	 * @return KeyObject
	...
	/**
	 * Returns a KeyObject to select entries with published states, i.e. which
	 * creates the SQL string '(FIELD_STATE = OPEN OR FIELD_STATE = SETTLED)'
	 * 
	 * @param inFieldState
	 *            String name of the state field
	 * @return KeyObject
	...
	/**
	 * Convenience method: Returns a KeyObject to select entries in visible
	 * groups.
	 * 
	 * @param inFieldState
	 *            String name of the state field
