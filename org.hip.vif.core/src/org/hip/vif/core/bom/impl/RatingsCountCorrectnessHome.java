...
/**
 * Home to retrieve the grouped ratings of the member's correctness.
 *
 * @author Luthiger
 * Created: 17.09.2010
 */
public class RatingsCountCorrectnessHome extends RatingsCountEfficiencyHome {
	private final static String OBJECT_CLASS_NAME = "org.hip.vif.core.bom.impl.RatingsCountCorrectness";
	private final static String XML_OBJECT_DEF = 
		"<?xml version='1.0' encoding='ISO-8859-1'?>	" +
		"<joinedObjectDef objectName='RatingsCountCorrectness' parent='org.hip.kernel.bom.ReadOnlyDomainObject' version='1.0'>	" +
		"	<columnDefs>	" +
		"		<columnDef columnName='" + RatingsHome.KEY_CORRECTNESS + "' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	" +
		"		<columnDef columnName='" + RatingsHome.KEY_CORRECTNESS + "' modifier='COUNT' as='Count' valueType='Number' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	" +
	...
	protected String getFieldName() {
		return RatingsHome.KEY_CORRECTNESS;
	}
