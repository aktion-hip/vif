...
public class TextHistoryHomeImpl extends DomainObjectHomeImpl implements TextHistoryHome {
	...
	private final static String XML_OBJECT_DEF = 
		...
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_VERSION + "' valueType='Number' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='nVersion'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_TITLE + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sTitle'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_AUTHOR + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sAuthor'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_COAUTHORS + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sCoAuthors'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_SUBTITLE + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sSubtitle'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_YEAR + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sYear'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_PUBLICATION + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sPublication'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_PAGES + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sPages'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_VOLUME + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='nVolume'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_NUMBER + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='nNumber'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_PUBLISHER + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sPublisher'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_PLACE + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sPlace'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_REFERENCE + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sReference'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_REMARK + "' valueType='String' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='sRemark'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_TYPE + "' valueType='Number' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='nType'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_STATE + "' valueType='Number' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='nState'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_FROM + "' valueType='Timestamp' propertyType='simple'>	" +
		"			<mappingDef tableName='tblTextVersionHistory' columnName='dtFrom'/>	" +
		"		</propertyDef>	" +
		"		<propertyDef propertyName='" + TextHome.KEY_TO + "' valueType='Timestamp' propertyType='simple'>	" +
