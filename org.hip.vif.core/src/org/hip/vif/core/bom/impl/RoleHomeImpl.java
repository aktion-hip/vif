...
public class RoleHomeImpl extends DomainObjectHomeImpl implements RoleHome {
	...
	*/
	...
	private final static String XML_OBJECT_DEF = 
		...
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + KEY_CODE_ID + "' valueType='String' propertyType='simple'>	\n" +
		...
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + KEY_GROUP_SPECIFIC + "' valueType='Number' propertyType='simple'>	\n" +
	...
	/*
	 * (non-Javadoc)
	 * @see org.hip.vif.core.bom.RoleHome#getGroupSpecificIDs()
	 */
	public Collection<String> getGroupSpecificIDs() throws VException, SQLException {
		Collection<String> out = new Vector<String>();
		KeyObject lKey = new KeyObjectImpl();
		lKey.setValue(KEY_GROUP_SPECIFIC, 1l);
		QueryResult lSelected = select(lKey);
