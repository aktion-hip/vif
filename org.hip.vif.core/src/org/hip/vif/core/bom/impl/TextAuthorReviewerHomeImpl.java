...
public class TextAuthorReviewerHomeImpl extends AbstractResponsibleHome implements TextAuthorReviewerHome {
	...
	*/
	...
	private final static String XML_OBJECT_DEF = 
		...
		"	<keyDefs>	\n" +
		"		<keyDef>	\n" +
		"			<keyItemDef seq='0' keyPropertyName='" + KEY_TEXT_ID + "'/>	\n" +
		"			<keyItemDef seq='1' keyPropertyName='" + KEY_VERSION + "'/>	\n" +
		"			<keyItemDef seq='2' keyPropertyName='" + ResponsibleHome.KEY_MEMBER_ID + "'/>	\n" +
		"		</keyDef>	\n" +
		"	</keyDefs>	\n" +
		"	<propertyDefs>	\n" +
	...
	public void setAuthor(Long inMemberID, Long inTextID, int inVersion) throws VException, SQLException {
	...
	public void setReviewer(Long inMemberID, Long inTextID, int inVersion) throws VException, SQLException {
		DomainObject lReviwer = create();
	...
	private void setAuthorReviewer(DomainObject inDomainObject, Long inMemberID, Long inTextID) throws VException, SQLException {
	 ...
	 */
	@Override
	public Responsible getAuthor(String inContributionID) throws VException, SQLException {
		String[] lTextID = inContributionID.split("-");
		KeyObject lKey = getContributionKey(new Integer(lTextID[0]));
	...
	public void removeReviewer(Long inReviewerID, Long inTextID, int inVersion) throws VException, SQLException {
	...
	public Member getAuthor(Long inTextID, int inVersion) throws Exception {
		KeyObject lKey = new KeyObjectImpl();
		lKey.setValue(TextAuthorReviewerHome.KEY_TEXT_ID, inTextID);
		lKey.setValue(TextAuthorReviewerHome.KEY_VERSION, new Long(inVersion));
		lKey.setValue(ResponsibleHome.KEY_TYPE, ResponsibleHome.Type.AUTHOR.getValue());
	...
	public boolean checkRefused(Long inReviewerID, Long inTextID, int inVersion) throws VException, SQLException {
		KeyObject lKey = new KeyObjectImpl();
		lKey.setValue(TextAuthorReviewerHome.KEY_TEXT_ID, inTextID);
		lKey.setValue(TextAuthorReviewerHome.KEY_VERSION, new Long(inVersion));
		lKey.setValue(ResponsibleHome.KEY_MEMBER_ID, inReviewerID);
