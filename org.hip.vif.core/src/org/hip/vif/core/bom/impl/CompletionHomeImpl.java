...
public class CompletionHomeImpl extends DomainObjectHomeImpl implements CompletionHome {
	...
	*/
	 ...
	 */
	public QueryResult getCompletions(String inQuestionID) throws VException, SQLException {
	...
	public QueryResult getPublished(Long inQuestionID) throws VException, SQLException {
		KeyObject lKey = new KeyObjectImpl();
		lKey.setValue(KEY_QUESTION_ID, inQuestionID);
	 ...
	 */
	public Completion getCompletion(String inCompletionID) throws VException, SQLException {
		return getCompletion(new Long(inCompletionID));
	}
	public Completion getCompletion(Long inCompletionID) throws VException, SQLException {
		KeyObject lKey = new KeyObjectImpl();
	 ...
	 */
	public QueryResult getSiblingCompletions(String inQuestionID, String inCompletionID) throws VException, SQLException {	
		return getSiblingCompletions(new Long(inQuestionID), new Long(inCompletionID));
	}
	public QueryResult getSiblingCompletions(Long inQuestionID, Long inCompletionID) throws VException, SQLException {	
		KeyObject lKey = new KeyObjectImpl();
		lKey.setValue(KEY_QUESTION_ID, inQuestionID);
		lKey.setValue(KEY_ID, inCompletionID, "!=");
		OrderObject lOrder = new OrderObjectImpl();
