...
/** Home of join from the GroupAdmin BOM to the Member BOM. This join can be used to retrieve the member data of all
 * group administrators for a specified discussion group.
 * 
...
public class JoinGroupAdminToMemberHome extends JoinedDomainObjectHomeImpl {
    ...
    public QueryResult select(final Long inGroupID) throws BOMChangeValueException {
        try {
