...
public class JoinMemberToPermissionHome extends JoinedDomainObjectHomeImpl {
    ...
    private final static String XML_OBJECT_DEF =
            "<?xml version='1.0' encoding='ISO-8859-1'?>	\n"
                    ...
                    + LinkMemberRoleHome.KEY_MEMBER_ID
                    + "' domainObject='org.hip.vif.core.bom.impl.LinkMemberRoleImpl'/>	\n"
                    +
                    "		<columnDef columnName='"
                    + RoleHome.KEY_ID
                    + "' alias='"
                    + KEY_ALIAS_ROLE_INT_ID
                    + "' domainObject='org.hip.vif.core.bom.impl.RoleImpl'/>	\n"
                    +
                    "		<columnDef columnName='"
                    ...
                    +
                    "			<columnDef columnName='"
                    + LinkMemberRoleHome.KEY_ROLE_ID
                    + "' domainObject='org.hip.vif.core.bom.impl.LinkMemberRoleImpl'/>	\n"
                    +
                    "			<columnDef columnName='"
                    + RoleHome.KEY_ID
    ...
    public QueryResult select(final Long inMemberID) throws BOMChangeValueException {
        try {
