...
public class PermissionHomeImpl extends DomainObjectHomeImpl implements PermissionHome {
	...
	*/
	 ...
	 */
	public Permission getPermission(Long inPermissionID) throws BOMInvalidKeyException {
	...
	/*
	 * (non-Javadoc)
	 * @see org.hip.vif.core.bom.PermissionHome#getPermission(java.lang.String)
	 */
	public Permission getPermission(String inPermissionID) throws BOMInvalidKeyException {
	...
	public Long createPermission(String inLabel, String inDescription) throws BOMException, ExternIDNotUniqueException {
		Permission lPermission = (Permission) create();
