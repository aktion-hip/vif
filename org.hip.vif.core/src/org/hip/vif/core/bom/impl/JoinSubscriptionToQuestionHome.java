...
/** Home managing models to join subscriptions with questions. This home can be used to find all questions a member has
 * subscribed to.
 *
...
public class JoinSubscriptionToQuestionHome extends JoinedDomainObjectHomeImpl {
    ...
    private final static String XML_OBJECT_DEF =
            "<?xml version='1.0' encoding='ISO-8859-1'?>	"
                    ...
                    + SubscriptionHome.KEY_MEMBERID
                    + "' domainObject='org.hip.vif.core.bom.impl.SubscriptionImpl'/>	\n"
                    +
                    "		<columnDef columnName='"
                    + SubscriptionHome.KEY_LOCAL
                    + "' domainObject='org.hip.vif.core.bom.impl.SubscriptionImpl'/>	\n"
                    +
                    "		<columnDef columnName='"
                    + QuestionHome.KEY_ID
                    + "' alias='"
                    + KEY_ALIAS_QUESTION_ID
                    ...
                    +
                    "			<columnDef columnName='"
                    + SubscriptionHome.KEY_QUESTIONID
                    + "' domainObject='org.hip.vif.core.bom.impl.SubscriptionImpl'/>	\n"
                    +
                    "			<columnDef columnName='"
                    + QuestionHome.KEY_ID
