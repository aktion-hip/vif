 ...
 * This home can be used to retrieve all text entries authored/reviewed by a
 * given person.<br/>
 * Note: Text entries are versioned and authors/reviewers are linked to a
 * specific version of a text entry.
 * 
 * @author Luthiger Created: 22.06.2010
 */
@SuppressWarnings("serial")
public class JoinAuthorReviewerToTextHome extends JoinedDomainObjectHomeImpl {
	private final static String OBJECT_CLASS_NAME = "org.hip.vif.core.bom.impl.JoinAuthorReviewerToText";
	...
	public QueryResult getAuthorsUnpublishedTexts(final Long inMemberID)
		...
		return getAuthorsTexts(inMemberID,
	...
	/**
	 * Returns the published version of the text entry identified by the
	 * specified id.
	 * 
	 * @param inTextID
	 *            Long
	...
	/**
	 * Parameter object containing the bibliography entry and the
	 * author/reviewer of this entry.
	 */
