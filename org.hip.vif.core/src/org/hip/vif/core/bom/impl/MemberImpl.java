...
public class MemberImpl extends AbstractMember implements Member, Indexable {
	...
	/**
	 * Creates a history entry and fills it with the values of the actual member
	 * entry except for the password, which is not copied.
	 */
	...
	/**
	 * Every subclass of DomainObject must provide the fully qualified name of
	 * its home class. It's good practice to define the name in a static
	 * variable and to return in this method those variable.
	 * 
	 ...
	 * because information about ID and password is filtered out.
	 * 
	 ...
	 * 
	 * @param inRoles
	 *            Collection of ids of roles assigned to the new member
	 * @return Long the new entry's MemberID
	 * @throws Exception
	 */
	@Override
	 ...
	 * @param inUserID
	 *            String
	 * @return boolean <code>true</code> if specified user id exists yet, else
	 *         <code>false</code>
	 * @throws Exception
	 */
	 ...
	 * @param inActorID
	 *            java.lang.Long
	 * @return boolean true if the members new roles are different from the old
	 *         ones.
	 * @exception org.hip.vif.core.exc.bom.impl.BOMChangeValueException
	 */
	@Override
	 ...
	 * member history table and the member index.
	 * 
	 * @param inActorID
	 *            java.lang.Long
	...
	/**
	 * This method overwrites the superclass' delete method. It throws an
	 * AssertionFailedError, because we want to force the user to use
	 * delete(Integer inActorID)
	 * 
	 * @param inActorID
	 *            java.lang.Integer
	 * @exception java.sql.SQLException
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.hip.vif.core.bom.Member#setUserSettings(java.lang.String,
	 * java.lang.String)
	 */
	@Override
