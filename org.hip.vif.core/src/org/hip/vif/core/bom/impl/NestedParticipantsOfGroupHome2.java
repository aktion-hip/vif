...
public class NestedParticipantsOfGroupHome2 extends NestedParticipantsOfGroupHome {
	...
	private final static String XML_OBJECT_DEF = 
		...
		"		<columnDef columnName='" + ParticipantHome.KEY_GROUP_ID + "' as='" + KEY_SUSPENDED_TEST1 + "' domainObject='org.hip.vif.core.bom.impl.ParticipantImpl'/>	\n" +
		"		<columnDef columnName='" + ParticipantHome.KEY_GROUP_ID + "' as='" + KEY_SUSPENDED_TEST2 + "' domainObject='org.hip.vif.core.bom.impl.ParticipantImpl'/>	\n" +
