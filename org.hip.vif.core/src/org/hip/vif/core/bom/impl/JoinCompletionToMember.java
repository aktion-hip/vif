...
/**
 * This class implements the join between the domain objects Completion and 
 * Member via CompletionAuthorReviewer. It can be used to retriev all 
 * Contributions and their authors and reviewers belonging to the same question.
 * 
