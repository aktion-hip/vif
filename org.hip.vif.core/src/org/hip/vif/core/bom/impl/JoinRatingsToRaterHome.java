...
/** Retrieves the name of the rated person for specified ratings. Can be used to retrieve all open ratings for a
 * specified participant (i.e. rater) too.
 *
...
public class JoinRatingsToRaterHome extends JoinedDomainObjectHomeImpl {
     ...
     * @throws VException
     * @throws SQLException */
    public JoinRatingsToRater getRating(final Long inRatingID, final Long inMemberID) throws VException, SQLException {
        final KeyObject lKey = new KeyObjectImpl();
        lKey.setValue(RatingsHome.KEY_RATINGEVENTS_ID, inRatingID);
        lKey.setValue(RatingsHome.KEY_RATER_ID, inMemberID);
        final QueryResult lResult = select(lKey);
