...
public class JoinRatingsToQuestionHome extends JoinedDomainObjectHomeImpl {
    ...
    private final static String XML_OBJECT_DEF =
            "<?xml version='1.0' encoding='ISO-8859-1'?>	"
                    ...
                    + RatingsQuestionHome.KEY_RATINGEVENTS_ID
                    + "' domainObject='org.hip.vif.core.bom.impl.RatingsQuestion'/>	\n"
                    +
                    "		<columnDef columnName='"
                    + QuestionHome.KEY_ID
                    ...
                    +
                    "			<columnDef columnName='"
                    + RatingsQuestionHome.KEY_QUESTION_ID
                    + "' domainObject='org.hip.vif.core.bom.impl.RatingsQuestion'/>	\n"
                    +
                    "			<columnDef columnName='"
                    + QuestionHome.KEY_ID
     ...
     * @throws VException
     * @throws SQLException */
    public QueryResult getQuestionsToBeRated(final Long inRatingEventsID) throws VException, SQLException {
