...
/**
 * Home of join from the question-author/reviewer BOM to the question BOM.
...
public class JoinAuthorReviewerToQuestionHome extends JoinedDomainObjectHomeImpl {
	 ...
	 * @throws SQLException
	 */
	public QueryResult getAuthorsQuestions(Long inAuthorID, Long inGroupID) throws VException, SQLException {
	 ...
	 * @deprecated
	 */
	public QueryResult getAuthorsQuestions(Long inAuthorID, String inGroupID) throws VException, SQLException {
	 ...
	 * @throws SQLException
	 */
	public QueryResult getReviewersQuestions(Long inReviewerID, Long inGroupID) throws VException, SQLException {
		KeyObject lKey = new KeyObjectImpl();
	 ...
	 * @deprecated
	 */
	public QueryResult getReviewersQuestions(Long inReviewerID, String inGroupID) throws VException, SQLException {
		return getReviewersQuestions(inReviewerID, new Long(inGroupID));
	}
	
	private QueryResult getQuestionsResponsibleFor(KeyObject inKey, Long inMemberID, Long inGroupID) throws VException, SQLException {
	 ...
	 * @throws SQLException
	 */
	public QueryResult getAuthorsQuestions(Long inAuthorID, Long inGroupID, Integer[] inState) throws VException, SQLException {
		KeyObject lKey = new KeyObjectImpl();
		lKey.setValue(ResponsibleHome.KEY_TYPE, ResponsibleHome.Type.AUTHOR.getValue());
	 ...
	 * @deprecated
	 */
	public QueryResult getAuthorsQuestions(Long inAuthorID, String inGroupID, Integer[] inState) throws VException, SQLException {
	 ...
	 * @throws SQLException
	 */
	public QueryResult getAuthorsUnpublishedQuestions(Long inAuthorID, Long inGroupID) throws VException, SQLException {
		return getAuthorsQuestions(inAuthorID, inGroupID, WorkflowAwareContribution.STATES_UNPUBLISHED);
	}
	/**
	 * @deprecated
	 */
	public QueryResult getAuthorsUnpublishedQuestions(Long inAuthorID, String inGroupID) throws VException, SQLException {
	 ...
	 * @throws SQLException
	 */
	public QueryResult getReviewersQuestions(Long inReviewerID, Long inGroupID, Integer[] inState) throws VException, SQLException {
		KeyObject lKey = new KeyObjectImpl();
		lKey.setValue(ResponsibleHome.KEY_TYPE, ResponsibleHome.Type.REVIEWER.getValue());
	 ...
	 * @deprecated
	 */
	public QueryResult getReviewersQuestions(Long inReviewerID, String inGroupID, Integer[] inState) throws VException, SQLException {
		return getReviewersQuestions(inReviewerID, new Long(inGroupID), inState);
	}
	
	private QueryResult getQuestionsResponsibleFor(KeyObject inKey, Long inMemberID, Long inGroupID, Integer[] inState) throws VException, SQLException {
		inKey.setValue(ResponsibleHome.KEY_MEMBER_ID, inMemberID);
	...
	/**
	 * Returns the Author's view of questions, i.e. all questions the specified
	 * user authors together with all questions having the specified states.
	 * 
	 ...
	 */
	public OutlinedQueryResult getAuthorView(Long inAuthorID, String inGroupID, Integer[] inState) throws VException, SQLException {
		KeyObject lKey = new KeyObjectImpl();
	 ...
	 * @throws SQLException
	 */
	public QueryResult getAuthorView(Long inAuthorID, Long inGroupID, Integer[] inState) throws VException, SQLException {
		KeyObject lKey = new KeyObjectImpl();
	...
	/**
	 * Returns the GroupAdmin's view of questions, i.e. all questions she authors
	 * together with all published (i.e. open or settled) questions.
	 * <b>Note:</b> this method doesn't verify whether the specified user is actually
	 * the GroupAdmin of the specified group.
	 * 
	 ...
	 */
	public OutlinedQueryResult getGroupAdminView(Long inGroupAdminID, String inGroupID) throws VException, SQLException {
	 ...
	 * @throws SQLException
	 */
	public QueryResult getGroupAdminView(Long inGroupAdminID, Long inGroupID) throws VException, SQLException {
		return getAuthorView(inGroupAdminID, inGroupID, WorkflowAwareContribution.STATES_PUBLISHED);
	}
