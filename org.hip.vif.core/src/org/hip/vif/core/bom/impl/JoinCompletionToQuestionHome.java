...
/** This join home can be used to retrieve all completions belonging to the same question.
 *
...
public class JoinCompletionToQuestionHome extends JoinedDomainObjectHomeImpl {
     ...
     * @throws VException
     * @throws SQLException */
    public JoinCompletionToQuestion getCompletion(final Long inCompletionID) throws VException, SQLException {
        final KeyObject lKey = new KeyObjectImpl();
     ...
     * @throws VException */
    public Long getGroupID(final Long inCompletionID) throws VException {
        final KeyObject lKey = new KeyObjectImpl();
        lKey.setValue(CompletionHome.KEY_ID, inCompletionID);
        final ReadOnlyDomainObject lEntry = findByKey(lKey);
