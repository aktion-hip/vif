...
public class CompletionHistoryHomeImpl extends DomainObjectHomeImpl implements CompletionHistoryHome  {
	...
	*/
	...
	private final static String XML_OBJECT_DEF = 
		...
		"	<keyDefs>	\n" +
		"		<keyDef>	\n" +
		"			<keyItemDef seq='0' keyPropertyName='" + CompletionHome.KEY_ID + "'/>	\n" +
		"			<keyItemDef seq='1' keyPropertyName='" + CompletionHome.KEY_MUTATION + "'/>	\n" +
		"			<keyItemDef seq='2' keyPropertyName='" + KEY_VALID_TO + "'/>	\n" +
		"		</keyDef>	\n" +
		"	</keyDefs>	\n" +
		"	<propertyDefs>	\n" +
		"		<propertyDef propertyName='" + CompletionHome.KEY_ID + "' valueType='Number' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblCompletionHistory' columnName='CompletionID'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + CompletionHome.KEY_MUTATION + "' valueType='Timestamp' propertyType='simple'>	\n" +
		...
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + CompletionHome.KEY_COMPLETION + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblCompletionHistory' columnName='sCompletion'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + CompletionHome.KEY_STATE + "' valueType='Number' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblCompletionHistory' columnName='nState'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + CompletionHome.KEY_QUESTION_ID + "' valueType='Number' propertyType='simple'>	\n" +
