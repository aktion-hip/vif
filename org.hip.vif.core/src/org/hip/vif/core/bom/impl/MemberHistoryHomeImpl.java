...
public class MemberHistoryHomeImpl extends DomainObjectHomeImpl implements MemberHistoryHome {
	...
	*/
	...
	private final static String XML_OBJECT_DEF = 
		...
		"	</keyDefs>	\n" +
		"	<propertyDefs>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_ID + "' valueType='Number' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='MEMBERID'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_MUTATION + "' valueType='Timestamp' propertyType='simple'>	\n" +
		...
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_USER_ID + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='SUSERID'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_NAME + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='SNAME'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_FIRSTNAME + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='SFIRSTNAME'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_STREET + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='SSTREET'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_ZIP + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='SZIP'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_CITY + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='SCITY'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_PHONE + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='STEL'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_FAX + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='SFAX'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_MAIL + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='SMAIL'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_SEX + "' valueType='Number' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='BSEX'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_LANGUAGE + "' valueType='String' propertyType='simple'>	\n" +
		"			<mappingDef tableName='tblMemberHistory' columnName='SLANGUAGE'/>	\n" +
		"		</propertyDef>	\n" +
		"		<propertyDef propertyName='" + MemberHome.KEY_SETTINGS + "' valueType='String' propertyType='simple'>	\n" +
	...
	/**
	 * 	Every class must provide some meta-data required by the 
	 *	lightweight DomainObject framework. This method returns
