...
public class MemberHomeImpl extends DomainObjectHomeImpl implements MemberHome {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.hip.vif.bom.MemberHome#checkAuthentication(java.lang.String,
	 * java.lang.String, org.hip.vif.servlets.VIFContext)
	 */
	@Override
	public Member checkAuthentication(final String inUserID,
		...
		try {
			if ("".equals(inUserID)) {
				...
				lMember.checkAuthentication(inPassword,
			...
			throw new InvalidAuthenticationException(
					"org.hip.vif.errmsg.input.invalidUserId",
					ApplicationData.getLocale());
		}
	...
	/**
	 * Every class must provide some meta-data required by the lightweight
	 * DomainObject framework. This method returns the definition string (in
	 * form of xml).
	 * 
	 * @return java.lang.String
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.hip.vif.bom.MemberHome#updateMemberCache(java.lang.String,
	 * org.hip.vif.member.MemberInformation)
	 */
	@Override
