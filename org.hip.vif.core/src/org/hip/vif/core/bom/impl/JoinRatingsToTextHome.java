...
public class JoinRatingsToTextHome extends JoinedDomainObjectHomeImpl {
    ...
    private final static String XML_OBJECT_DEF =
            "<?xml version='1.0' encoding='ISO-8859-1'?>	"
                    ...
                    + RatingsTextHome.KEY_RATINGEVENTS_ID
                    + "' domainObject='org.hip.vif.core.bom.impl.RatingsText'/>	\n"
                    +
                    "		<columnDef columnName='"
                    + TextHome.KEY_ID
     ...
     * @throws VException
     * @throws SQLException */
    public QueryResult getTextsToBeRated(final Long inRatingEventsID) throws VException, SQLException {
