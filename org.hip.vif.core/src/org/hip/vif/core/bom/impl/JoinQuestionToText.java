...
public class JoinQuestionToText extends DomainObjectImpl {
	public final static String HOME_CLASS_NAME = "org.hip.vif.core.bom.impl.JoinQuestionToTextHome";
	...
	public void accept(DomainObjectVisitor inVisitor) {
		try {
			BibliographyFormatter lFormatter = new BibliographyFormatter(new BibliographyAdapter(this, TextHome.KEY_BIBLIO_TYPE));
