...
/**
 * Home to select all groups with all participants registered including a column 
 * with the MemberID of the registered participants. 
 * This home can be used to filter all private groups a specified 
 * member participates in.
 * 
 * @author Benno Luthiger
 * Created on Dec 31, 2003
 */
public class NestedGroupHome2 extends JoinedDomainObjectHomeImpl {
	...
	"		<columnDef columnName='" + GroupHome.KEY_ID + "' alias='" + KEY_GROUP_ID + "' domainObject='org.hip.vif.core.bom.impl.GroupImpl'/>	\n" +
	...
	"		<hidden columnName='" + ParticipantHome.KEY_MEMBER_ID + "' domainObject='org.hip.vif.core.bom.impl.ParticipantImpl'/>	\n" +
	"	</columnDefs>	\n" +
	...
	"				<columnDef columnName='" + ParticipantHome.KEY_GROUP_ID + "' domainObject='org.hip.vif.core.bom.impl.ParticipantImpl'/>	\n" +
	"				<columnDef columnName='" + ParticipantHome.KEY_MEMBER_ID + "' as='" + KEY_REGISTERED + "' modifier='COUNT' domainObject='org.hip.vif.core.bom.impl.ParticipantImpl'/>	\n" +
	...
	/**
	 * NestedGroupHome2 constructor.
	 */
	public NestedGroupHome2() {
		super();
	}
