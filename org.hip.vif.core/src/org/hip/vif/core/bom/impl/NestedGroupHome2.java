...
/** Home to select all groups with all participants registered including a column with the MemberID of the registered
 * participants. This home can be used to filter all private groups a specified member participates in.
 *
