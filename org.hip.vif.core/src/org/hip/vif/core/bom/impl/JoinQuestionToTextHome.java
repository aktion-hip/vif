...
public class JoinQuestionToTextHome extends JoinedDomainObjectHomeImpl {
	private final static String OBJECT_CLASS_NAME = "org.hip.vif.core.bom.impl.JoinQuestionToText";
	...
	private final static String XML_OBJECT_DEF = 
		...
		"		<columnDef columnName='" + TextHome.KEY_AUTHOR + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		"		<columnDef columnName='" + TextHome.KEY_COAUTHORS + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		"		<columnDef columnName='" + TextHome.KEY_SUBTITLE + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		"		<columnDef columnName='" + TextHome.KEY_YEAR + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		"		<columnDef columnName='" + TextHome.KEY_PUBLICATION + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		"		<columnDef columnName='" + TextHome.KEY_PAGES + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		"		<columnDef columnName='" + TextHome.KEY_VOLUME + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		"		<columnDef columnName='" + TextHome.KEY_NUMBER + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		"		<columnDef columnName='" + TextHome.KEY_PUBLISHER + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		"		<columnDef columnName='" + TextHome.KEY_PLACE + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		"		<columnDef columnName='" + TextHome.KEY_TYPE + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	" +
		...
		"		<columnDef columnName='" + TextHome.KEY_TYPE + "' as='" + TextHome.KEY_BIBLIO_TYPE + "' domainObject='org.hip.vif.core.bom.impl.TextImpl'/>	\n" +
		"	</columnDefs>	" +
