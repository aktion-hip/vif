...
public class RatingsCalculateHome extends JoinedDomainObjectHomeImpl {
    ...
    private final static String XML_OBJECT_DEF =
            "<?xml version='1.0' encoding='ISO-8859-1'?>	"
                    ...
                    + RatingsHome.KEY_CORRECTNESS
                    + "' modifier='SUM' as='Sum1' valueType='Number' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	"
                    +
                    "		<columnDef columnName='"
                    + RatingsHome.KEY_EFFICIENCY
                    + "' modifier='SUM' as='Sum2' valueType='Number' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	"
                    +
                    "		<columnDef columnName='"
                    + RatingsHome.KEY_ETIQUETTE
                    + "' modifier='SUM' as='Sum3' valueType='Number' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	"
                    +
                    "		<columnDef columnName='"
                    + RatingsHome.KEY_CORRECTNESS
                    + "' modifier='AVG' template='{0} * 100' as='Mean1' valueType='Number' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	"
                    +
                    "		<columnDef columnName='"
                    + RatingsHome.KEY_EFFICIENCY
                    + "' modifier='AVG' template='{0} * 100' as='Mean2' valueType='Number' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	"
                    +
                    "		<columnDef columnName='"
                    + RatingsHome.KEY_ETIQUETTE
                    + "' modifier='AVG' template='{0} * 100' as='Mean3' valueType='Number' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	"
                    +
                    "		<columnDef columnName='"
                    + RatingsHome.KEY_CORRECTNESS
                    + "' modifier='COUNT' as='Count1' valueType='Number' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	"
                    +
                    "		<columnDef columnName='"
                    + RatingsHome.KEY_EFFICIENCY
                    + "' modifier='COUNT' as='Count2' valueType='Number' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	"
                    +
                    "		<columnDef columnName='"
                    + RatingsHome.KEY_ETIQUETTE
                    + "' modifier='COUNT' as='Count3' valueType='Number' domainObject='org.hip.vif.core.bom.impl.Ratings'/>	"
                    +
                    "		<hidden columnName='"
