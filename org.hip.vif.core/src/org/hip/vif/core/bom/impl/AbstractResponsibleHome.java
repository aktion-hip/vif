...
public abstract class AbstractResponsibleHome extends DomainObjectHomeImpl implements ResponsibleHome {
	 ...
	 * @throws SQLException
	 */
	public Responsible getResponsible(String inContributionID, Long inMemberID) throws VException, SQLException {
		KeyObject lKey = getContributionKey(new Integer(inContributionID));
