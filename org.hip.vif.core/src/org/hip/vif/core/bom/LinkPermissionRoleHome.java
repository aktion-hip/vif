...
/** LinkPermissionRoleHome is responsible to manage instances of class org.hip.vif.bom.LinkPermissionRole.
 *
...
public interface LinkPermissionRoleHome extends DomainObjectHome {
    ...
    /** Retrieves all roles associated with the specified permission.
     *
     * @param inPermissionID Long the permission's ID
     * @return Collection&lt;Role> the associated roles
     * @throws BOMInvalidKeyException */
    Collection<Role> getRolesOf(final Long inPermissionID) throws BOMInvalidKeyException;
