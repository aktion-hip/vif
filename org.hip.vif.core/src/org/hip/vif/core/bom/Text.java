...
public interface Text extends DomainObject {
     ...
     * 
     * @param inTextID Long the entries ID
     * @param inVersion int the version of the new text entry
     * @param inReference String the existing version's reference
     * @param inValues {@link ITextValues}
     * @param inActorID Long
     * @return Long the id of the newly created <code>Text</code> entry.
     * @throws BOMChangeValueException */
    ...
    /** Use case: the business object's values have changed, therefore, persist these changes.
     * 
     * @param inActorID Long the author's id
     * @throws BOMChangeValueException */
    ...
    /** Validates the instance, i.e. checks whether the instance's fields <code>title</code>, <code>author</code> and
     * <code>year</code> are filled.
     * 
