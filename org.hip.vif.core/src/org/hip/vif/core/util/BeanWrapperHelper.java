...
public class BeanWrapperHelper {
	 ...
	 * 
	 * @param inKey
	 *            String the value's key in the domain object
	 * @param inDomainObject
	 *            {@link GeneralDomainObject} the object
	...
	/**
	 * Returns a plain <code>String</code> value from the domain object.
	 * Possible <code>Textile</code> format markers are removed.
	 * 
	 * @param inKey
	 *            String the value's key in the domain object
	 * @param inDomainObject
	 *            {@link GeneralDomainObject} the object
	 * @return String the value extracted from the domain object with any style
	 *         removed
	 */
