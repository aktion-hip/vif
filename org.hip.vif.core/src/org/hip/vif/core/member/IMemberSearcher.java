...
public interface IMemberSearcher {
	...
	/**
	 * This method gives information about whether this <code>MemberSearcher</code> can show all member entries in the member store.
	 * 
	...
	/**
	 * This method gives information about whether this <code>MemberSearcher</code> can order the member entries retrieved.
	 * 
	...
	/**
	 * Returns an instance of <code>MemberHome</code> managing the entries (i.e. <code>Member</code>) residing in an external database.<br />
	...
	/**
	 * Returns an instance of <code>MemberHome</code> managing the entries (i.e. <code>Member</code>) residing in the internal members cache.<br />
	...
	/**
	 * Creates an entry in the members cache for the <code>Member</code> with specified member ID.
	 * If the member entry exists yet, the member information is updated.
	 * This method returns an array of unique IDs of the members in the members cache.
	 * If this functionality is not needed, nothing is done and the inputed array of member IDs is returned as is.
	 * 
	...
	/**
	 * Returns the ID of the member's entry in the table of cached members given the ID of the member's entry in the external member table.
	 * If there's no external member table, the specified ID is returned as is.
	 * 
	 * @param inMemberID Long Member ID (unique identification) in authentication store. In a database, this usually is a number.
