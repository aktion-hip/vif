...
public class MemberContainer extends BeanItemContainer<MemberWrapper> {
	...
	public static final String[] NATURAL_COL_ORDER = new String[] {"userID", MEMBER_NAME, MEMBER_STREET, MEMBER_PLACE, MEMBER_MAIL}; //$NON-NLS-1$
	public static String[] COL_HEADERS = new String[] {"ui.member.label.userid", "ui.member.label.name", "ui.member.label.street", "ui.member.label.city", "ui.member.label.mail"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
	 ...
	 * @throws SQLException
	 */
	public static MemberContainer createData(QueryResult inMembers) throws VException, SQLException {
		MemberContainer outContainer = new MemberContainer();
