...
public class RoleWrapper {
    ...
    private final boolean isGroupSpecific;
    ...
    private RoleWrapper(final String inElementID, final String inLabel, final boolean inChecked,
            final boolean inGroupSpecific) {
    ...
    public static RoleWrapper createItem(final String inElementID, final String inLabel, final boolean inChecked,
            final boolean inGroupSpecific) {
