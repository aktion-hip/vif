...
public class QueryHelper {
     ...
     * @throws Exception */
    public static IMemberQueryStrategy getQueryStrategy(final ParameterObject inParameters) throws Exception {
    ...
    public static class QueryDBTable implements IMemberQueryStrategy {
        ...
        @Override
        public QueryResult getQueryResult(final OrderObject inOrder) throws VException, SQLException {
    ...
    public static class QueryHitsList implements IMemberQueryStrategy {
        private final IMemberSearcher searcher;

        QueryHitsList(final String inQueryString) throws Exception {
            searcher = MemberUtility.INSTANCE.getActiveMemberSearcher();
            searcher.prepareSearch(inQueryString);
        }

        public QueryHitsList(final String inName, final String inFirstName, final String inStreet,
                final String inPostal, final String inCity, final String inMail) throws Exception {
            searcher = MemberUtility.INSTANCE.getActiveMemberSearcher();
