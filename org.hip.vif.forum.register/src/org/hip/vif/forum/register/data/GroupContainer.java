...
public class GroupContainer extends BeanItemContainer<GroupWrapper> {
	...
	public static final String[] NATURAL_COL_ORDER = new String[] {GROUP_CHK, "name", "description", "registered", "state"};     //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	public static final String[] COL_HEADERS = new String[] {"", "container.group.headers.short.description", "container.group.headers.description", "container.group.headers.number.of", "container.table.headers.state"};      //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
	 ...
	 * @throws SQLException
	 */
	public static GroupContainer createData(QueryResult inGroups, Collection<Long> inRegisterings, CodeList inCodeList) throws VException, SQLException {
