...
public class GroupWrapper implements ISelectableBean {
     ...
     * @param inCodeList */
    private GroupWrapper(final GeneralDomainObject inDomainObject, final Collection<Long> inRegisterings,
    ...
    public static GroupWrapper createItem(final GeneralDomainObject inDomainObject,
            final Collection<Long> inRegisterings, final CodeList inCodeList) {
        final GroupWrapper outGroup = new GroupWrapper(inDomainObject, inRegisterings, inCodeList);
        return outGroup;
    }
