...
public class GroupContainer extends BeanItemContainer<GroupWrapper> {
    public static final Object[] NATURAL_COL_ORDER = new Object[] { "name", "description" }; //$NON-NLS-1$ //$NON-NLS-2$
    public static final String[] COL_HEADERS = new String[] {
        "container.group.headers.short.description", "container.group.headers.description" }; //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * @throws VException
     * @throws SQLException */
    public static GroupContainer createData(final QueryResult inGroups) throws VException, SQLException {
