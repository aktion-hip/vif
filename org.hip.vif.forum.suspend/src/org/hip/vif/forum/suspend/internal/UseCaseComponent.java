...
public class UseCaseComponent implements IUseCaseForum {
	...
	public IVIFMenuItem getMenu() {
		VIFMenuComposite outMenu = new VIFMenuComposite(Activator.getMessages().getMessage("component.menu.title"), 40); //$NON-NLS-1$
		outMenu.setTaskName(UseCaseHelper.createFullyQualifiedTaskName(SuspendTask.class));
