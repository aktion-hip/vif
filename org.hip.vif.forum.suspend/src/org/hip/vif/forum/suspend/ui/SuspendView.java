...
public class SuspendView extends CustomComponent {
    ...
    public SuspendView(GroupContainer inGroups, DatePrepare inDates, final SuspendTask inTask) {
        ...
        lLayout.addComponent(new Label(String.format(VIFViewHelper.TMPL_TITLE,
                "vif-pagetitle", lMessages.getMessage("ui.suspend.view.title.page")), Label.CONTENT_XHTML)); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        lLayout.addComponent(VIFViewHelper.createSpacer());
        lLayout.addComponent(new Label(String.format(VIFViewHelper.TMPL_TITLE,
                "vif-subtitle", lMessages.getMessage("ui.suspend.view.subtitle")), Label.CONTENT_XHTML)); //$NON-NLS-1$ //$NON-NLS-2$
