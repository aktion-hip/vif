...
import org.hip.vif.web.dash.AdminDashBoard;
...
public class Admin extends VIFApplication {
	private final static Logger LOG = LoggerFactory.getLogger(Admin.class);
